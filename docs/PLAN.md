...
`scripts/api_parity.py` (gate: `--check`). Started at 21.9 % (413 / 1,888); 22.9 % after 8.0 (extras 401 → 72, all the scalar-kernel exception); 25.6 % after 8.1b-3; 31.2 % after P08; 47.0 % after P09a, P02 and P09b; 53.0 % after P03 and P10; 64.0 % after P04 / P05 (8.2c) and P12; 68.9 % after P11b and P07; 72.7 % after P11a; **74.7 % after P06** (1,401 ported, 15 partial, 460 missing, 560 excluded; 0 undocumented extras). WP 8.0b aligns `simba::Real` names on simba-rs (`is_sign_negative`, `T::pi()`, …).
