...
// PATCH: upstream imports this trait from alexandria_data_structures::vec @ 800f5ad; inlined verbatim
// (doc comments removed) to avoid pulling a 2.5-era alexandria that no longer compiles.
trait VecTrait<V, T> {
    fn new() -> V;
