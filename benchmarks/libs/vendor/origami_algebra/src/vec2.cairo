...
pub impl Vec2Copy<T, impl TCopy: Copy<T>> of Copy<Vec2<T>>;
pub impl Vec2Drop<T, impl TDrop: Drop<T>> of Drop<Vec2<T>>;

pub trait Vec2Trait<T> {
    // Constructors
...
pub impl Vec2Impl<T, impl TCopy: Copy<T>, impl TDrop: Drop<T>> of Vec2Trait<T> {
    // Constructors
