...
# `MatrixInfSup<M>` (`root.cairo`, the kernel of `nalgebra::inf` / `sup` / `inf_sup`), implemented
# in each shape's module as its `inf` / `sup` / `inf_sup` (WP 8.6-P21).
CROSS_FILE_TRAITS = {"Norm", "MatrixInfSup"}
