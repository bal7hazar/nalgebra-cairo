...
//!
//! Moved from `crates/nalgebra/src/geometry/translation2/tests.cairo` (WP 8.1c, test-only package).
...
use nalgebra_tests_utils::{ONE_RAW, fx, p2t, t2t, v2t};
use simba::scalar::Real;
use crate::translation2::oracle;
