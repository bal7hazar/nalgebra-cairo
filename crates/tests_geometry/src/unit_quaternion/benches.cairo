...
//!
//! Moved from `crates/nalgebra/src/geometry/unit_quaternion/benches.cairo` (WP 8.1c, test-only
...
use nalgebra_tests_utils::{fx, int, m3, u3t, uqt, v3t};
...
fn bench_unit_quaternion_new_normalize__divisions() {
    ...
    let e = black_box(uqt((784150157, 1568300315, -2352450472, 3136600629)));
...
fn bench_unit_quaternion_axis__try_new() {
    let q = black_box(a());
    let e = black_box(u3t((2738208060, 2417871747, -2258950401)));
...
fn bench_unit_quaternion_scaled_axis__divisions() {
    let q = black_box(a());
    let e = black_box(v3t((6635905207, 5859586768, -5474449130)));
...
fn bench_unit_quaternion_scaled_axis__alt_factor() {
    let q = black_box(a());
    let e = black_box(v3t((6635905207, 5859586767, -5474449130)));
...
fn bench_unit_quaternion_rotation_between__algebraic() {
    let x = black_box(v());
    let y = black_box(w());
    let e = black_box(uqt((4089636155, 611444113, 1087011755, 407629408)));
...
fn bench_unit_quaternion_nlerp__lerp_normalize() {
    ...
    let e = black_box(uqt((-2383027036, -2519790274, -1139680147, 2262678139)));
...
fn bench_unit_quaternion_slerp__acos_sin() {
    ...
    let r = black_box(b());
    let t = black_box(fx(0x40000000));
    let e = black_box(uqt((-685896195, -2393123539, -2985529558, 1826434634)));
...
fn bench_unit_quaternion_powf__axis_angle() {
    ...
    let e = black_box(uqt((3530512512, 1559329777, 1376907572, -1286406493)));
    assert!(q.powf(n) == e);
}
...
fn bench_unit_quaternion_append_axisangle_linearized__reduced_product() {
    let q = black_box(a());
    let x = black_box(w());
    let e = black_box(uqt((-1511968454, -2770073695, -2511442522, 1476497089)));
