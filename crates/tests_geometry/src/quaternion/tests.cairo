...
//! ```
//!
//! Moved from `crates/nalgebra/src/geometry/quaternion/tests.cairo` (WP 8.1c, test-only package):
...
use nalgebra_tests_utils::{ONE_RAW, fx, int, qi, qt, v3};
use simba::scalar::Real;
use crate::quaternion::oracle;
