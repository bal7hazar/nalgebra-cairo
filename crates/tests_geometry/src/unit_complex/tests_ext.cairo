...
//! ```
//!
//! Moved from `crates/nalgebra/src/geometry/unit_complex/tests_ext.cairo` (WP 8.1c, test-only
...
use crate::unit_complex::oracle_ext;
...
fn test_from_matrix_exact_cases() {
    ...
    let (re, im) = (c().re, c().im);
    let r3 = nalgebra::base::matrix2::Matrix2 {
