...
//! <oracle.cairo>`.
//!
//! Moved from `crates/nalgebra/src/geometry/isometry2/tests.cairo` (WP 8.1c, test-only package):
...
use nalgebra_tests_utils::{ONE_RAW, fx, iso2t, m3, p2t, uct, v2t};
use simba::scalar::Real;
use crate::isometry2::oracle;
