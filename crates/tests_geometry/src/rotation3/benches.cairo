...
//!
//! Moved from `crates/nalgebra/src/geometry/rotation3/benches.cairo` (WP 8.1c, test-only package):
//! the tests of crate-internal items stay there.

use fixed::Fixed;
use nalgebra::base::MatrixTrMul;
...
use nalgebra_tests_utils::{fx, r3, u3t, v3t};
