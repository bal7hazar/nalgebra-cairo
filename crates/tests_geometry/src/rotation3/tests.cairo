...
//! ```
//!
//! Moved from `crates/nalgebra/src/geometry/rotation3/tests.cairo` (WP 8.1c, test-only package):
...
use nalgebra_tests_utils::{ONE_RAW, fx, int, m3, r3, r3i, u3t, uqt, v3i, v3t};
use simba::scalar::Real;
use crate::rotation3::oracle;
