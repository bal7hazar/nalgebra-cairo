...
//!
//! Moved from `crates/nalgebra/src/geometry/similarity2/tests.cairo` (WP 8.1c, test-only package).
...
use nalgebra_tests_utils::{ONE_RAW, fx, p2t, sim2t, uct, v2t};
use simba::scalar::Real;
use crate::similarity2::oracle;
