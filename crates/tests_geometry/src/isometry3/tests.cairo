...
//! <oracle.cairo>`.
//!
//! Moved from `crates/nalgebra/src/geometry/isometry3/tests.cairo` (WP 8.1c, test-only package):
...
use nalgebra_tests_utils::{ONE_RAW, fx, int, iso3t, m4, p3t, uqt, v3t};
use simba::scalar::Real;
use crate::isometry3::oracle;
