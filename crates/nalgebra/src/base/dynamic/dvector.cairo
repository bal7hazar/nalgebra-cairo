...
pub impl Matrix1IntoDVector<
    T, +Copy<T>, +Drop<T>,
> of Into<super::super::matrix1::Matrix1<T>, DVector<T>> {
    #[inline]
    fn into(self: super::super::matrix1::Matrix1<T>) -> DVector<T> {
        DVector { data: array![self.x].span() }
    }
}

/// The `DVector` of the 2 components of a `Vector2`. Upstream: `From<Matrix> for DVector`.
pub impl Vector2IntoDVector<
    T, +Copy<T>, +Drop<T>,
> of Into<super::super::vector2::Vector2<T>, DVector<T>> {
    #[inline]
    fn into(self: super::super::vector2::Vector2<T>) -> DVector<T> {
        DVector { data: array![self.x, self.y].span() }
    }
}

/// The `DVector` of the 3 components of a `Vector3`. Upstream: `From<Matrix> for DVector`.
pub impl Vector3IntoDVector<
    T, +Copy<T>, +Drop<T>,
> of Into<super::super::vector3::Vector3<T>, DVector<T>> {
    #[inline]
    fn into(self: super::super::vector3::Vector3<T>) -> DVector<T> {
...
pub impl Vector4IntoDVector<
    T, +Copy<T>, +Drop<T>,
> of Into<super::super::vector4::Vector4<T>, DVector<T>> {
    #[inline]
    fn into(self: super::super::vector4::Vector4<T>) -> DVector<T> {
...
pub impl Vector5IntoDVector<
    T, +Copy<T>, +Drop<T>,
> of Into<super::super::vector5::Vector5<T>, DVector<T>> {
    #[inline]
    fn into(self: super::super::vector5::Vector5<T>) -> DVector<T> {
...
pub impl Vector6IntoDVector<
    T, +Copy<T>, +Drop<T>,
> of Into<super::super::vector6::Vector6<T>, DVector<T>> {
    #[inline]
    fn into(self: super::super::vector6::Vector6<T>) -> DVector<T> {
