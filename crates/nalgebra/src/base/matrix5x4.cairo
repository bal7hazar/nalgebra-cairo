...
> of Matrix5x4Trait<T> {
    ...
    fn zip_map<
        ...
        +Drop<Func::Output>,
    >(
        self: Matrix5x4<T>, rhs: Matrix5x4<T2>, f: F,
    ) -> Matrix5x4<Func::Output> {
        Matrix5x4 {
    ...
    fn zip_zip_map<
        ...
        +Drop<Func::Output>,
    >(
        self: Matrix5x4<T>, b: Matrix5x4<T2>, c: Matrix5x4<T3>, f: F,
    ) -> Matrix5x4<Func::Output> {
        Matrix5x4 {
    ...
    >(
        self: Matrix5x4<T>, rhs: Matrix5x4<T2>, init: Acc, f: F,
    ) -> Acc {
    ...
    fn zip_apply<
        ...
        +Into<Func::Output, T>,
    >(
        ref self: Matrix5x4<T>, rhs: Matrix5x4<T2>, f: F,
    ) {
        self =
            Matrix5x4 {
    ...
    fn zip_zip_apply<
        ...
        +Into<Func::Output, T>,
    >(
        ref self: Matrix5x4<T>, b: Matrix5x4<T2>, c: Matrix5x4<T3>, f: F,
    ) {
        self =
            Matrix5x4 {
    ...
    fn fill(ref self: Matrix5x4<T>, val: T) {
        self =
            Matrix5x4 {
                m11: val,
                m21: val,
    ...
    fn fill_diagonal(ref self: Matrix5x4<T>, val: T) {
        self =
            Matrix5x4 {
                m11: val,
                m21: self.m21,
    ...
    fn fill_with_identity(ref self: Matrix5x4<T>) {
        self =
            Matrix5x4 {
                m11: R::one(),
                m21: R::zero(),
    ...
    fn fill_column(ref self: Matrix5x4<T>, j: usize, val: T) {
        self = match j {
            0 => Matrix5x4 {
                m11: val,
                m21: val,
    ...
    fn fill_upper_triangle(ref self: Matrix5x4<T>, val: T, shift: usize) {
        self = match shift {
            0 => Matrix5x4 {
                m11: val,
                m21: self.m21,
    ...
    fn set_row(ref self: Matrix5x4<T>, i: usize, row: RowVector4<T>) {
        self = match i {
            0 => Matrix5x4 {
                m11: row.x,
                m21: self.m21,
    ...
    fn set_column(ref self: Matrix5x4<T>, j: usize, column: Vector5<T>) {
        self = match j {
            0 => Matrix5x4 {
                m11: column.x,
                m21: column.y,
    ...
    fn set_diagonal(ref self: Matrix5x4<T>, diag: Vector4<T>) {
        self =
            Matrix5x4 {
                m11: diag.x,
                m21: self.m21,
    ...
    fn set_partial_diagonal(ref self: Matrix5x4<T>, diag: Span<T>) {
        let len = diag.len();
        self =
            Matrix5x4 {
                m11: if len > 0 {
    ...
    /// Sets `self` to `other` (a `Matrix5x4`: upstream requires the same shape). Upstream:
    /// `copy_from`.
    #[inline(always)]
    fn copy_from(ref self: Matrix5x4<T>, other: Matrix5x4<T>) {
        self = other;
    }
    ...
    /// (`&[T]`).
    #[inline(always)]
    fn copy_from_slice(ref self: Matrix5x4<T>, slice: Span<T>) {
        self = Self::from_column_slice(slice);
    }

    /// Sets `self` to the transpose of `other`, a `Matrix4x5`. Exact. Upstream: `tr_copy_from`.
    fn tr_copy_from(ref self: Matrix5x4<T>, other: Matrix4x5<T>) {
        self =
            Matrix5x4 {
                m11: other.m11,
                m21: other.m12,
    ...
    fn swap(ref self: Matrix5x4<T>, row_cols1: (usize, usize), row_cols2: (usize, usize)) {
        ...
        self =
            Matrix5x4EditTrait::replace(
                Matrix5x4EditTrait::replace(self, row_cols1, b), row_cols2, a,
            );
    }
    ...
    #[inline(always)]
    fn neg_mut(ref self: Matrix5x4<T>) {
        self = -self;
    }
    ...
    /// `scale_mut`.
    #[inline(always)]
    fn scale_mut(ref self: Matrix5x4<T>, k: T) {
    ...
    #[inline(always)]
    fn unscale_mut(ref self: Matrix5x4<T>, k: T) {
    ...
    #[inline(always)]
    fn normalize_mut(ref self: Matrix5x4<T>) -> T {
        let n = Self::norm(self);
    ...
    #[inline(always)]
    fn try_normalize_mut(ref self: Matrix5x4<T>, min_norm: T) -> Option<T> {
        let n = Self::norm(self);
        if n <= min_norm {
            return None;
        }
    ...
    #[inline(always)]
    fn set_magnitude(ref self: Matrix5x4<T>, magnitude: T) {
        let n = Self::norm(self);
        self = Self::scale(self, R::div(magnitude, n));
    }
    ...
    /// `conjugate_mut`.
    #[inline(always)]
    fn conjugate_mut(ref self: Matrix5x4<T>) {
        self = Self::conjugate(self);
    }

    /// Writes the transpose of `self` into `out`, a `Matrix4x5`. Exact. Upstream: `transpose_to`.
    #[inline(always)]
    fn transpose_to(self: Matrix5x4<T>, ref out: Matrix4x5<T>) {
        out = Self::transpose(self);
    }

    /// Writes the adjoint of `self` (its transpose for a real scalar) into `out`, a `Matrix4x5`.
    /// Exact. Upstream: `adjoint_to`.
    #[inline(always)]
    fn adjoint_to(self: Matrix5x4<T>, ref out: Matrix4x5<T>) {
        out = Self::transpose(self);
    }

    /// Writes the adjoint of `self` (deprecated upstream alias of `adjoint_to`) into `out`, a
    /// `Matrix4x5`. Exact. Upstream: `conjugate_transpose_to`.
    #[inline(always)]
    fn conjugate_transpose_to(self: Matrix5x4<T>, ref out: Matrix4x5<T>) {
        out = Self::transpose(self);
    }

    /// Writes the sum `self + rhs` into `out`. Exact; panics on overflow. Upstream: `add_to`.
    #[inline(always)]
    fn add_to(self: Matrix5x4<T>, rhs: Matrix5x4<T>, ref out: Matrix5x4<T>) {
        out = self + rhs;
    }
    ...
    /// `sub_to`.
    #[inline(always)]
    fn sub_to(self: Matrix5x4<T>, rhs: Matrix5x4<T>, ref out: Matrix5x4<T>) {
        out = self - rhs;
    }
    ...
    #[inline(always)]
    fn nrows(self: Matrix5x4<T>) -> usize {
        5
    }

    /// The number of columns, 4. Upstream: `ncols`.
    #[inline(always)]
    fn ncols(self: Matrix5x4<T>) -> usize {
        4
    }

    /// `(nrows, ncols)`, `(5, 4)`. Upstream: `shape`.
    #[inline(always)]
    fn shape(self: Matrix5x4<T>) -> (usize, usize) {
        (5, 4)
    }

    /// Whether the shape is square: `false`. Upstream: `is_square`.
    #[inline(always)]
    fn is_square(self: Matrix5x4<T>) -> bool {
        false
    }
    ...
    #[inline(always)]
    fn vector_to_matrix_index(self: Matrix5x4<T>, i: usize) -> (usize, usize) {
    ...
    #[inline(always)]
    fn row(self: Matrix5x4<T>, i: usize) -> RowVector4<T> {
        Matrix5x4EditTrait::row_at(self, i)
    }
    ...
    #[inline(always)]
    fn column(self: Matrix5x4<T>, j: usize) -> Vector5<T> {
        Matrix5x4EditTrait::column_at(self, j)
    }
    ...
    #[inline(always)]
    fn upper_triangle(self: Matrix5x4<T>) -> Matrix5x4<T> {
        Matrix5x4 {
            m11: self.m11,
            m21: R::zero(),
            m31: R::zero(),
    ...
    #[inline(always)]
    fn lower_triangle(self: Matrix5x4<T>) -> Matrix5x4<T> {
        Matrix5x4 {
            m11: self.m11,
            m21: self.m21,
            m31: self.m31,
    ...
    /// The 5x4 matrix whose 5 rows are the given vectors, each a `Vector4` of the row's 4
    ...
    #[inline(always)]
    fn from_rows(
        r1: Vector4<T>, r2: Vector4<T>, r3: Vector4<T>, r4: Vector4<T>, r5: Vector4<T>,
    ) -> Matrix5x4<T> {
        Matrix5x4 {
            m11: r1.x,
            m21: r2.x,
    ...
    /// The 5x4 matrix whose 4 columns are the given `Vector5`s. Exact. Upstream: `from_columns` (a
    /// slice of column vectors).
    #[inline(always)]
    fn from_columns(
        c1: Vector5<T>, c2: Vector5<T>, c3: Vector5<T>, c4: Vector5<T>,
    ) -> Matrix5x4<T> {
        Matrix5x4 {
            m11: c1.x,
            m21: c1.y,
    ...
    #[inline(always)]
    fn is_orthogonal(self: Matrix5x4<T>, ulps: u64) -> bool {
        Matrix4Trait::is_identity(MatrixTrMul::tr_mul(self, self), ulps)
    }

    /// `self` with a row of `val` inserted at index `i` (`i <= 5`), a `Matrix6x4`. Panics with
    /// `nalgebra: index out of bounds` for `i > 5`. Upstream: `insert_row`.
    fn insert_row(self: Matrix5x4<T>, i: usize, val: T) -> Matrix6x4<T> {
        match i {
            0 => Matrix6x4 {
                m11: val,
                m21: self.m11,
    ...
    /// `self` with a column of `val` inserted at index `i` (`i <= 4`), a `Matrix5`. Panics with
    /// `nalgebra: index out of bounds` for `i > 4`. Upstream: `insert_column`.
    fn insert_column(self: Matrix5x4<T>, i: usize, val: T) -> Matrix5<T> {
        match i {
            0 => Matrix5 {
                m11: val,
                m21: val,
    ...
    /// `self` without its row `i`, a `Matrix4`. Panics with `nalgebra: index out of bounds` for `i
    /// >= 5`. Upstream: `remove_row`.
    #[inline(always)]
    fn remove_row(self: Matrix5x4<T>, i: usize) -> Matrix4<T> {
        match i {
            0 => Matrix4 {
                m11: self.m21,
                m21: self.m31,
    ...
    /// `self` without its column `i`, a `Matrix5x3`. Panics with `nalgebra: index out of bounds`
    /// for `i >= 4`. Upstream: `remove_column`.
    #[inline(always)]
    fn remove_column(self: Matrix5x4<T>, i: usize) -> Matrix5x3<T> {
        match i {
            0 => Matrix5x3 {
                m11: self.m12,
                m21: self.m22,
...
#[generate_trait]
impl Matrix5x4EditImpl<T, +Copy<T>, +Drop<T>> of Matrix5x4EditTrait<T> {
    /// `self` with the component at `index` (`(row, column)`) replaced by `v`; panics out of
    /// bounds.
    fn replace(self: Matrix5x4<T>, index: (usize, usize), v: T) -> Matrix5x4<T> {
        let (i, j) = index;
        match j {
            0 => match i {
                0 => Matrix5x4 {
    ...
    fn row_at(self: Matrix5x4<T>, i: usize) -> RowVector4<T> {
        match i {
    ...
    fn column_at(self: Matrix5x4<T>, j: usize) -> Vector5<T> {
        match j {
...
/// The 1 consecutive rows of a `Matrix5x4` as a `RowVector4`. Upstream: `fixed_rows::<1>`, `rows(i,
...
> of FixedRows<Matrix5x4<T>, RowVector4<T>> {
    ...
    #[inline(always)]
    fn rows(self: Matrix5x4<T>, first_row: usize, nrows: usize) -> RowVector4<T> {
        if nrows != 1 {
    ...
    #[inline(always)]
    fn rows_range(self: Matrix5x4<T>, rows: Range<usize>) -> RowVector4<T> {
...
/// The 2 consecutive rows of a `Matrix5x4` as a `Matrix2x4`. Upstream: `fixed_rows::<2>`, `rows(i,
...
> of FixedRows<Matrix5x4<T>, Matrix2x4<T>> {
    ...
    #[inline(always)]
    fn rows(self: Matrix5x4<T>, first_row: usize, nrows: usize) -> Matrix2x4<T> {
        if nrows != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Matrix5x4<T>, rows: Range<usize>) -> Matrix2x4<T> {
        let Range { start, end } = rows;
        if end != start + 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 3 consecutive rows of a `Matrix5x4` as a `Matrix3x4`. Upstream: `fixed_rows::<3>`, `rows(i,
...
> of FixedRows<Matrix5x4<T>, Matrix3x4<T>> {
    ...
    #[inline(always)]
    fn rows(self: Matrix5x4<T>, first_row: usize, nrows: usize) -> Matrix3x4<T> {
        if nrows != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Matrix5x4<T>, rows: Range<usize>) -> Matrix3x4<T> {
        let Range { start, end } = rows;
        if end != start + 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 4 consecutive rows of a `Matrix5x4` as a `Matrix4`. Upstream: `fixed_rows::<4>`, `rows(i,
...
pub impl Matrix5x4FixedRowsMatrix4<T, +Copy<T>, +Drop<T>> of FixedRows<Matrix5x4<T>, Matrix4<T>> {
    ...
    #[inline(always)]
    fn rows(self: Matrix5x4<T>, first_row: usize, nrows: usize) -> Matrix4<T> {
        if nrows != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Matrix5x4<T>, rows: Range<usize>) -> Matrix4<T> {
        let Range { start, end } = rows;
        if end != start + 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 5 consecutive rows of a `Matrix5x4` as a `Matrix5x4`. Upstream: `fixed_rows::<5>`, `rows(i,
...
> of FixedRows<Matrix5x4<T>, Matrix5x4<T>> {
    ...
    #[inline(always)]
    fn rows(self: Matrix5x4<T>, first_row: usize, nrows: usize) -> Matrix5x4<T> {
        if nrows != 5 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Matrix5x4<T>, rows: Range<usize>) -> Matrix5x4<T> {
        let Range { start, end } = rows;
        if end != start + 5 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 1 consecutive columns of a `Matrix5x4` as a `Vector5`. Upstream: `fixed_columns::<1>`,
...
> of FixedColumns<Matrix5x4<T>, Vector5<T>> {
    ...
    #[inline(always)]
    fn columns(self: Matrix5x4<T>, first_col: usize, ncols: usize) -> Vector5<T> {
        if ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
    ...
    #[inline(always)]
    fn columns_range(self: Matrix5x4<T>, cols: Range<usize>) -> Vector5<T> {
...
/// The 2 consecutive columns of a `Matrix5x4` as a `Matrix5x2`. Upstream: `fixed_columns::<2>`,
...
> of FixedColumns<Matrix5x4<T>, Matrix5x2<T>> {
    ...
    #[inline(always)]
    fn columns(self: Matrix5x4<T>, first_col: usize, ncols: usize) -> Matrix5x2<T> {
        if ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_columns(self, first_col)
    ...
    #[inline(always)]
    fn columns_range(self: Matrix5x4<T>, cols: Range<usize>) -> Matrix5x2<T> {
        let Range { start, end } = cols;
        if end != start + 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 3 consecutive columns of a `Matrix5x4` as a `Matrix5x3`. Upstream: `fixed_columns::<3>`,
...
> of FixedColumns<Matrix5x4<T>, Matrix5x3<T>> {
    ...
    #[inline(always)]
    fn columns(self: Matrix5x4<T>, first_col: usize, ncols: usize) -> Matrix5x3<T> {
        if ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_columns(self, first_col)
    ...
    #[inline(always)]
    fn columns_range(self: Matrix5x4<T>, cols: Range<usize>) -> Matrix5x3<T> {
        let Range { start, end } = cols;
        if end != start + 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 4 consecutive columns of a `Matrix5x4` as a `Matrix5x4`. Upstream: `fixed_columns::<4>`,
...
> of FixedColumns<Matrix5x4<T>, Matrix5x4<T>> {
    ...
    #[inline(always)]
    fn columns(self: Matrix5x4<T>, first_col: usize, ncols: usize) -> Matrix5x4<T> {
        if ncols != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_columns(self, first_col)
    ...
    #[inline(always)]
    fn columns_range(self: Matrix5x4<T>, cols: Range<usize>) -> Matrix5x4<T> {
        let Range { start, end } = cols;
        if end != start + 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 1x1 blocks of a `Matrix5x4` as a `Matrix1`. Upstream: `fixed_view::<1, 1>`, `view`, and the
...
pub impl Matrix5x4FixedViewMatrix1<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x4<T>, Matrix1<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix1<T> {
        let (irow, icol) = start;
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix1<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix1<T> {
        Self::view(self, start, shape)
    }
}

/// The 1x2 blocks of a `Matrix5x4` as a `RowVector2`. Upstream: `fixed_view::<1, 2>`, `view`, and
...
> of FixedView<Matrix5x4<T>, RowVector2<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 1 || ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> RowVector2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector2<T> {
        Self::view(self, start, shape)
    }
}

/// The 1x3 blocks of a `Matrix5x4` as a `RowVector3`. Upstream: `fixed_view::<1, 3>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x4<T>, RowVector3<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 1 || ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> RowVector3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector3<T> {
        Self::view(self, start, shape)
    }
}

/// The 1x4 blocks of a `Matrix5x4` as a `RowVector4`. Upstream: `fixed_view::<1, 4>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x4<T>, RowVector4<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector4<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 1 || ncols != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> RowVector4<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector4<T> {
        Self::view(self, start, shape)
    }
}

/// The 2x1 blocks of a `Matrix5x4` as a `Vector2`. Upstream: `fixed_view::<2, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x4FixedViewVector2<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x4<T>, Vector2<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Vector2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 2 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Vector2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Vector2<T> {
        Self::view(self, start, shape)
    }
}

/// The 2x2 blocks of a `Matrix5x4` as a `Matrix2`. Upstream: `fixed_view::<2, 2>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x4FixedViewMatrix2<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x4<T>, Matrix2<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 2 || ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix2<T> {
        Self::view(self, start, shape)
    }
}

/// The 2x3 blocks of a `Matrix5x4` as a `Matrix2x3`. Upstream: `fixed_view::<2, 3>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x4<T>, Matrix2x3<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix2x3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 2 || ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix2x3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix2x3<T> {
        Self::view(self, start, shape)
    }
}

/// The 2x4 blocks of a `Matrix5x4` as a `Matrix2x4`. Upstream: `fixed_view::<2, 4>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x4<T>, Matrix2x4<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix2x4<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 2 || ncols != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix2x4<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix2x4<T> {
        Self::view(self, start, shape)
    }
}

/// The 3x1 blocks of a `Matrix5x4` as a `Vector3`. Upstream: `fixed_view::<3, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x4FixedViewVector3<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x4<T>, Vector3<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Vector3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 3 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Vector3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Vector3<T> {
        Self::view(self, start, shape)
    }
}

/// The 3x2 blocks of a `Matrix5x4` as a `Matrix3x2`. Upstream: `fixed_view::<3, 2>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x4<T>, Matrix3x2<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix3x2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 3 || ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix3x2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix3x2<T> {
        Self::view(self, start, shape)
    }
}

/// The 3x3 blocks of a `Matrix5x4` as a `Matrix3`. Upstream: `fixed_view::<3, 3>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x4FixedViewMatrix3<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x4<T>, Matrix3<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 3 || ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix3<T> {
        Self::view(self, start, shape)
    }
}

/// The 3x4 blocks of a `Matrix5x4` as a `Matrix3x4`. Upstream: `fixed_view::<3, 4>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x4<T>, Matrix3x4<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix3x4<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 3 || ncols != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix3x4<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix3x4<T> {
        Self::view(self, start, shape)
    }
}

/// The 4x1 blocks of a `Matrix5x4` as a `Vector4`. Upstream: `fixed_view::<4, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x4FixedViewVector4<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x4<T>, Vector4<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Vector4<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 4 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Vector4<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Vector4<T> {
        Self::view(self, start, shape)
    }
}

/// The 4x2 blocks of a `Matrix5x4` as a `Matrix4x2`. Upstream: `fixed_view::<4, 2>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x4<T>, Matrix4x2<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix4x2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 4 || ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix4x2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix4x2<T> {
        Self::view(self, start, shape)
    }
}

/// The 4x3 blocks of a `Matrix5x4` as a `Matrix4x3`. Upstream: `fixed_view::<4, 3>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x4<T>, Matrix4x3<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix4x3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 4 || ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix4x3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix4x3<T> {
        Self::view(self, start, shape)
    }
}

/// The 4x4 blocks of a `Matrix5x4` as a `Matrix4`. Upstream: `fixed_view::<4, 4>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x4FixedViewMatrix4<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x4<T>, Matrix4<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix4<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 4 || ncols != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix4<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix4<T> {
        Self::view(self, start, shape)
    }
}

/// The 5x1 blocks of a `Matrix5x4` as a `Vector5`. Upstream: `fixed_view::<5, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x4FixedViewVector5<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x4<T>, Vector5<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Vector5<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 5 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Vector5<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Vector5<T> {
        Self::view(self, start, shape)
    }
}

/// The 5x2 blocks of a `Matrix5x4` as a `Matrix5x2`. Upstream: `fixed_view::<5, 2>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x4<T>, Matrix5x2<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix5x2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 5 || ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix5x2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix5x2<T> {
        Self::view(self, start, shape)
    }
}

/// The 5x3 blocks of a `Matrix5x4` as a `Matrix5x3`. Upstream: `fixed_view::<5, 3>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x4<T>, Matrix5x3<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix5x3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 5 || ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix5x3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix5x3<T> {
        Self::view(self, start, shape)
    }
}

/// The 5x4 blocks of a `Matrix5x4` as a `Matrix5x4`. Upstream: `fixed_view::<5, 4>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x4<T>, Matrix5x4<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix5x4<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 5 || ncols != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x4<T>, irow: usize, icol: usize) -> Matrix5x4<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x4<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix5x4<T> {
        Self::view(self, start, shape)
    }
}

/// The first 1 components of a row of a `Matrix5x4` as a `Matrix1`. Upstream: `row_part` (`n = 1`).
pub impl Matrix5x4RowPartMatrix1<T, +Copy<T>, +Drop<T>> of RowPart<Matrix5x4<T>, Matrix1<T>> {
    #[inline(always)]
    fn row_part(self: Matrix5x4<T>, i: usize, n: usize) -> Matrix1<T> {
        if n != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The first 2 components of a row of a `Matrix5x4` as a `RowVector2`. Upstream: `row_part` (`n =
/// 2`).
pub impl Matrix5x4RowPartRowVector2<T, +Copy<T>, +Drop<T>> of RowPart<Matrix5x4<T>, RowVector2<T>> {
    #[inline(always)]
    fn row_part(self: Matrix5x4<T>, i: usize, n: usize) -> RowVector2<T> {
        if n != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, i, 0)
...
/// The first 3 components of a row of a `Matrix5x4` as a `RowVector3`. Upstream: `row_part` (`n =
/// 3`).
pub impl Matrix5x4RowPartRowVector3<T, +Copy<T>, +Drop<T>> of RowPart<Matrix5x4<T>, RowVector3<T>> {
    #[inline(always)]
    fn row_part(self: Matrix5x4<T>, i: usize, n: usize) -> RowVector3<T> {
        if n != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, i, 0)
...
/// The first 4 components of a row of a `Matrix5x4` as a `RowVector4`. Upstream: `row_part` (`n =
/// 4`).
pub impl Matrix5x4RowPartRowVector4<T, +Copy<T>, +Drop<T>> of RowPart<Matrix5x4<T>, RowVector4<T>> {
    #[inline(always)]
    fn row_part(self: Matrix5x4<T>, i: usize, n: usize) -> RowVector4<T> {
        if n != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, i, 0)
...
/// The first 1 components of a column of a `Matrix5x4` as a `Matrix1`. Upstream: `column_part` (`n
/// = 1`).
pub impl Matrix5x4ColumnPartMatrix1<T, +Copy<T>, +Drop<T>> of ColumnPart<Matrix5x4<T>, Matrix1<T>> {
    #[inline(always)]
    fn column_part(self: Matrix5x4<T>, i: usize, n: usize) -> Matrix1<T> {
        if n != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The first 2 components of a column of a `Matrix5x4` as a `Vector2`. Upstream: `column_part` (`n
/// = 2`).
pub impl Matrix5x4ColumnPartVector2<T, +Copy<T>, +Drop<T>> of ColumnPart<Matrix5x4<T>, Vector2<T>> {
    #[inline(always)]
    fn column_part(self: Matrix5x4<T>, i: usize, n: usize) -> Vector2<T> {
        if n != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
...
/// The first 3 components of a column of a `Matrix5x4` as a `Vector3`. Upstream: `column_part` (`n
/// = 3`).
pub impl Matrix5x4ColumnPartVector3<T, +Copy<T>, +Drop<T>> of ColumnPart<Matrix5x4<T>, Vector3<T>> {
    #[inline(always)]
    fn column_part(self: Matrix5x4<T>, i: usize, n: usize) -> Vector3<T> {
        if n != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
...
/// The first 4 components of a column of a `Matrix5x4` as a `Vector4`. Upstream: `column_part` (`n
/// = 4`).
pub impl Matrix5x4ColumnPartVector4<T, +Copy<T>, +Drop<T>> of ColumnPart<Matrix5x4<T>, Vector4<T>> {
    #[inline(always)]
    fn column_part(self: Matrix5x4<T>, i: usize, n: usize) -> Vector4<T> {
        if n != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
...
/// The first 5 components of a column of a `Matrix5x4` as a `Vector5`. Upstream: `column_part` (`n
/// = 5`).
pub impl Matrix5x4ColumnPartVector5<T, +Copy<T>, +Drop<T>> of ColumnPart<Matrix5x4<T>, Vector5<T>> {
    #[inline(always)]
    fn column_part(self: Matrix5x4<T>, i: usize, n: usize) -> Vector5<T> {
        if n != 5 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
