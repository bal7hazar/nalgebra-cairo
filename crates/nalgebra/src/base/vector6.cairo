...
/// The 1 consecutive rows of a `Vector6` as a `Matrix1`. Upstream: `fixed_rows::<1>`, `rows(i, 1)`,
...
pub impl Vector6FixedRowsMatrix1<T, +Copy<T>, +Drop<T>> of FixedRows<Vector6<T>, Matrix1<T>> {
    ...
    #[inline(always)]
    fn rows(self: Vector6<T>, first_row: usize, nrows: usize) -> Matrix1<T> {
        if nrows != 1 {
    ...
    #[inline(always)]
    fn rows_range(self: Vector6<T>, rows: Range<usize>) -> Matrix1<T> {
...
/// The 2 consecutive rows of a `Vector6` as a `Vector2`. Upstream: `fixed_rows::<2>`, `rows(i, 2)`,
/// `rows_range`, `select_rows`.
pub impl Vector6FixedRowsVector2<T, +Copy<T>, +Drop<T>> of FixedRows<Vector6<T>, Vector2<T>> {
    ...
    #[inline(always)]
    fn rows(self: Vector6<T>, first_row: usize, nrows: usize) -> Vector2<T> {
        if nrows != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Vector6<T>, rows: Range<usize>) -> Vector2<T> {
        let Range { start, end } = rows;
        if end != start + 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 3 consecutive rows of a `Vector6` as a `Vector3`. Upstream: `fixed_rows::<3>`, `rows(i, 3)`,
/// `rows_range`, `select_rows`.
pub impl Vector6FixedRowsVector3<T, +Copy<T>, +Drop<T>> of FixedRows<Vector6<T>, Vector3<T>> {
    ...
    #[inline(always)]
    fn rows(self: Vector6<T>, first_row: usize, nrows: usize) -> Vector3<T> {
        if nrows != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Vector6<T>, rows: Range<usize>) -> Vector3<T> {
        let Range { start, end } = rows;
        if end != start + 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 4 consecutive rows of a `Vector6` as a `Vector4`. Upstream: `fixed_rows::<4>`, `rows(i, 4)`,
/// `rows_range`, `select_rows`.
pub impl Vector6FixedRowsVector4<T, +Copy<T>, +Drop<T>> of FixedRows<Vector6<T>, Vector4<T>> {
    ...
    #[inline(always)]
    fn rows(self: Vector6<T>, first_row: usize, nrows: usize) -> Vector4<T> {
        if nrows != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Vector6<T>, rows: Range<usize>) -> Vector4<T> {
        let Range { start, end } = rows;
        if end != start + 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 5 consecutive rows of a `Vector6` as a `Vector5`. Upstream: `fixed_rows::<5>`, `rows(i, 5)`,
/// `rows_range`, `select_rows`.
pub impl Vector6FixedRowsVector5<T, +Copy<T>, +Drop<T>> of FixedRows<Vector6<T>, Vector5<T>> {
    ...
    #[inline(always)]
    fn rows(self: Vector6<T>, first_row: usize, nrows: usize) -> Vector5<T> {
        if nrows != 5 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Vector6<T>, rows: Range<usize>) -> Vector5<T> {
        let Range { start, end } = rows;
        if end != start + 5 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 6 consecutive rows of a `Vector6` as a `Vector6`. Upstream: `fixed_rows::<6>`, `rows(i, 6)`,
/// `rows_range`, `select_rows`.
pub impl Vector6FixedRowsVector6<T, +Copy<T>, +Drop<T>> of FixedRows<Vector6<T>, Vector6<T>> {
    ...
    #[inline(always)]
    fn rows(self: Vector6<T>, first_row: usize, nrows: usize) -> Vector6<T> {
        if nrows != 6 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Vector6<T>, rows: Range<usize>) -> Vector6<T> {
        let Range { start, end } = rows;
        if end != start + 6 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 1 consecutive columns of a `Vector6` as a `Vector6`. Upstream: `fixed_columns::<1>`,
...
pub impl Vector6FixedColumnsVector6<T, +Copy<T>, +Drop<T>> of FixedColumns<Vector6<T>, Vector6<T>> {
    ...
    #[inline(always)]
    fn columns(self: Vector6<T>, first_col: usize, ncols: usize) -> Vector6<T> {
        if ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
    ...
    #[inline(always)]
    fn columns_range(self: Vector6<T>, cols: Range<usize>) -> Vector6<T> {
...
/// The 1x1 blocks of a `Vector6` as a `Matrix1`. Upstream: `fixed_view::<1, 1>`, `view`, and the
...
pub impl Vector6FixedViewMatrix1<T, +Copy<T>, +Drop<T>> of FixedView<Vector6<T>, Matrix1<T>> {
    ...
    #[inline(always)]
    fn view(self: Vector6<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix1<T> {
        let (irow, icol) = start;
    ...
    #[inline(always)]
    fn fixed_slice(self: Vector6<T>, irow: usize, icol: usize) -> Matrix1<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Vector6<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix1<T> {
        Self::view(self, start, shape)
    }
}

/// The 2x1 blocks of a `Vector6` as a `Vector2`. Upstream: `fixed_view::<2, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Vector6FixedViewVector2<T, +Copy<T>, +Drop<T>> of FixedView<Vector6<T>, Vector2<T>> {
    ...
    #[inline(always)]
    fn view(self: Vector6<T>, start: (usize, usize), shape: (usize, usize)) -> Vector2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 2 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Vector6<T>, irow: usize, icol: usize) -> Vector2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Vector6<T>, start: (usize, usize), shape: (usize, usize)) -> Vector2<T> {
        Self::view(self, start, shape)
    }
}

/// The 3x1 blocks of a `Vector6` as a `Vector3`. Upstream: `fixed_view::<3, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Vector6FixedViewVector3<T, +Copy<T>, +Drop<T>> of FixedView<Vector6<T>, Vector3<T>> {
    ...
    #[inline(always)]
    fn view(self: Vector6<T>, start: (usize, usize), shape: (usize, usize)) -> Vector3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 3 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Vector6<T>, irow: usize, icol: usize) -> Vector3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Vector6<T>, start: (usize, usize), shape: (usize, usize)) -> Vector3<T> {
        Self::view(self, start, shape)
    }
}

/// The 4x1 blocks of a `Vector6` as a `Vector4`. Upstream: `fixed_view::<4, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Vector6FixedViewVector4<T, +Copy<T>, +Drop<T>> of FixedView<Vector6<T>, Vector4<T>> {
    ...
    #[inline(always)]
    fn view(self: Vector6<T>, start: (usize, usize), shape: (usize, usize)) -> Vector4<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 4 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Vector6<T>, irow: usize, icol: usize) -> Vector4<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Vector6<T>, start: (usize, usize), shape: (usize, usize)) -> Vector4<T> {
        Self::view(self, start, shape)
    }
}

/// The 5x1 blocks of a `Vector6` as a `Vector5`. Upstream: `fixed_view::<5, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Vector6FixedViewVector5<T, +Copy<T>, +Drop<T>> of FixedView<Vector6<T>, Vector5<T>> {
    ...
    #[inline(always)]
    fn view(self: Vector6<T>, start: (usize, usize), shape: (usize, usize)) -> Vector5<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 5 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Vector6<T>, irow: usize, icol: usize) -> Vector5<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Vector6<T>, start: (usize, usize), shape: (usize, usize)) -> Vector5<T> {
        Self::view(self, start, shape)
    }
}

/// The 6x1 blocks of a `Vector6` as a `Vector6`. Upstream: `fixed_view::<6, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Vector6FixedViewVector6<T, +Copy<T>, +Drop<T>> of FixedView<Vector6<T>, Vector6<T>> {
    ...
    #[inline(always)]
    fn view(self: Vector6<T>, start: (usize, usize), shape: (usize, usize)) -> Vector6<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 6 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Vector6<T>, irow: usize, icol: usize) -> Vector6<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Vector6<T>, start: (usize, usize), shape: (usize, usize)) -> Vector6<T> {
        Self::view(self, start, shape)
    }
}

/// The first 1 components of a row of a `Vector6` as a `Matrix1`. Upstream: `row_part` (`n = 1`).
pub impl Vector6RowPartMatrix1<T, +Copy<T>, +Drop<T>> of RowPart<Vector6<T>, Matrix1<T>> {
    #[inline(always)]
    fn row_part(self: Vector6<T>, i: usize, n: usize) -> Matrix1<T> {
        if n != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The first 1 components of a column of a `Vector6` as a `Matrix1`. Upstream: `column_part` (`n =
/// 1`).
pub impl Vector6ColumnPartMatrix1<T, +Copy<T>, +Drop<T>> of ColumnPart<Vector6<T>, Matrix1<T>> {
    #[inline(always)]
    fn column_part(self: Vector6<T>, i: usize, n: usize) -> Matrix1<T> {
        if n != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The first 2 components of a column of a `Vector6` as a `Vector2`. Upstream: `column_part` (`n =
/// 2`).
pub impl Vector6ColumnPartVector2<T, +Copy<T>, +Drop<T>> of ColumnPart<Vector6<T>, Vector2<T>> {
    #[inline(always)]
    fn column_part(self: Vector6<T>, i: usize, n: usize) -> Vector2<T> {
        if n != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
...
/// The first 3 components of a column of a `Vector6` as a `Vector3`. Upstream: `column_part` (`n =
/// 3`).
pub impl Vector6ColumnPartVector3<T, +Copy<T>, +Drop<T>> of ColumnPart<Vector6<T>, Vector3<T>> {
    #[inline(always)]
    fn column_part(self: Vector6<T>, i: usize, n: usize) -> Vector3<T> {
        if n != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
...
/// The first 4 components of a column of a `Vector6` as a `Vector4`. Upstream: `column_part` (`n =
/// 4`).
pub impl Vector6ColumnPartVector4<T, +Copy<T>, +Drop<T>> of ColumnPart<Vector6<T>, Vector4<T>> {
    #[inline(always)]
    fn column_part(self: Vector6<T>, i: usize, n: usize) -> Vector4<T> {
        if n != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
...
/// The first 5 components of a column of a `Vector6` as a `Vector5`. Upstream: `column_part` (`n =
/// 5`).
pub impl Vector6ColumnPartVector5<T, +Copy<T>, +Drop<T>> of ColumnPart<Vector6<T>, Vector5<T>> {
    #[inline(always)]
    fn column_part(self: Vector6<T>, i: usize, n: usize) -> Vector5<T> {
        if n != 5 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
...
/// The first 6 components of a column of a `Vector6` as a `Vector6`. Upstream: `column_part` (`n =
/// 6`).
pub impl Vector6ColumnPartVector6<T, +Copy<T>, +Drop<T>> of ColumnPart<Vector6<T>, Vector6<T>> {
    #[inline(always)]
    fn column_part(self: Vector6<T>, i: usize, n: usize) -> Vector6<T> {
        if n != 6 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
