...
/// `selfᵀ * rhs` without forming the transpose, a `Vector2`: the 5 products of each component
...
/// `selfᵀ * rhs` without forming the transpose, a `Matrix2`: the 5 products of each component
/// accumulated exactly in `Real::Wide` and rescaled once. Bit-identical to
/// `self.transpose().mul_mat(rhs)`. Panics on overflow. Upstream: `tr_mul`.
...
/// `selfᵀ * rhs` without forming the transpose, a `Matrix2x3`: the 5 products of each component
/// accumulated exactly in `Real::Wide` and rescaled once. Bit-identical to
/// `self.transpose().mul_mat(rhs)`. Panics on overflow. Upstream: `tr_mul`.
...
/// `selfᵀ * rhs` without forming the transpose, a `Matrix2x4`: the 5 products of each component
/// accumulated exactly in `Real::Wide` and rescaled once. Bit-identical to
/// `self.transpose().mul_mat(rhs)`. Panics on overflow. Upstream: `tr_mul`.
...
/// `selfᵀ * rhs` without forming the transpose, a `Matrix2x5`: the 5 products of each component
/// accumulated exactly in `Real::Wide` and rescaled once. Bit-identical to
/// `self.transpose().mul_mat(rhs)`. Panics on overflow. Upstream: `tr_mul`.
...
/// `selfᵀ * rhs` without forming the transpose, a `Matrix2x6`: the 5 products of each component
/// accumulated exactly in `Real::Wide` and rescaled once. Bit-identical to
/// `self.transpose().mul_mat(rhs)`. Panics on overflow. Upstream: `tr_mul`.
