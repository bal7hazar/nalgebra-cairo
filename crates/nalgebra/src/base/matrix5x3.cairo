...
> of Matrix5x3Trait<T> {
    ...
    /// The 5x3 matrix whose components all equal `elem`. Upstream: `Matrix5x3::repeat`.
    #[inline(always)]
    fn repeat(elem: T) -> Matrix5x3<T> {
        Matrix5x3 {
            m11: elem,
            m21: elem,
            m31: elem,
    ...
    /// Alias of `repeat`. Upstream: `Matrix5x3::from_element`.
    #[inline(always)]
    fn from_element(elem: T) -> Matrix5x3<T> {
        Matrix5x3 {
            m11: elem,
            m21: elem,
            m31: elem,
    ...
    /// The 5x3 matrix whose component `(i, j)` (row, column, 0-based) is `f(i, j)`, `f` being
    ...
    /// The 5x3 matrix of the 15 values of `data`, in row-major order. Panics with `nalgebra: wrong
    /// slice length` unless `data.len() == 15`. Upstream: `Matrix5x3::from_row_slice` (`&[T]`).
    ///
    ...
    #[inline(always)]
    fn from_row_slice(data: Span<T>) -> Matrix5x3<T> {
    ...
    /// wrong slice length` unless `data.len() == 15`. Upstream: `Matrix5x3::from_column_slice`
    /// (`&[T]`).
    ///
    /// `data` is read as ONE fixed-size array (`Span -> @Box<[T; 15]>`, one length check): measured
    /// about 5 times cheaper than a bounds-checked `*data[k]` per component
    /// (`bench_matrix3_from_row_slice__alt_span_index`).
    #[inline(always)]
    fn from_column_slice(data: Span<T>) -> Matrix5x3<T> {
        let boxed: @Box<[T; 15]> = data.try_into().expect(errors::SLICE_LENGTH);
        let [v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14] = boxed.unbox();
        Matrix5x3 {
            m11: v0,
    ...
    /// The 5x3 matrix whose first `data.len()` diagonal components are `data`, every other
    /// component zero. Panics with `nalgebra: diagonal too long` when `data.len() > 3`. Upstream:
    /// `Matrix5x3::from_partial_diagonal` (`&[T]`).
    #[inline(always)]
    fn from_partial_diagonal(data: Span<T>) -> Matrix5x3<T> {
        let len = data.len();
        if len > 3 {
    ...
    #[inline(always)]
    fn is_zero(self: Matrix5x3<T>) -> bool {
        self.m11 == R::zero()
            && self.m21 == R::zero()
            && self.m31 == R::zero()
            && self.m41 == R::zero()
    ...
    #[inline(always)]
    fn component_mul(self: Matrix5x3<T>, rhs: Matrix5x3<T>) -> Matrix5x3<T> {
        Matrix5x3 {
    ...
    #[inline(always)]
    fn component_mul_assign(ref self: Matrix5x3<T>, rhs: Matrix5x3<T>) {
        self =
            Matrix5x3 {
                m11: self.m11 * rhs.m11,
                m21: self.m21 * rhs.m21,
    ...
    #[inline(always)]
    fn component_div(self: Matrix5x3<T>, rhs: Matrix5x3<T>) -> Matrix5x3<T> {
        Matrix5x3 {
    ...
    #[inline(always)]
    fn component_div_assign(ref self: Matrix5x3<T>, rhs: Matrix5x3<T>) {
        self =
            Matrix5x3 {
                m11: R::div(self.m11, rhs.m11),
                m21: R::div(self.m21, rhs.m21),
    ...
    #[inline(always)]
    fn inf(self: Matrix5x3<T>, other: Matrix5x3<T>) -> Matrix5x3<T> {
        Matrix5x3 {
    ...
    #[inline(always)]
    fn sup(self: Matrix5x3<T>, other: Matrix5x3<T>) -> Matrix5x3<T> {
        Matrix5x3 {
    ...
    #[inline(always)]
    fn inf_sup(self: Matrix5x3<T>, other: Matrix5x3<T>) -> (Matrix5x3<T>, Matrix5x3<T>) {
        (Self::inf(self, other), Self::sup(self, other))
    }

    /// `self + k` added to every component. Exact; panics on overflow. Upstream: `add_scalar`.
    #[inline(always)]
    fn add_scalar(self: Matrix5x3<T>, k: T) -> Matrix5x3<T> {
        Matrix5x3 {
            m11: self.m11 + k,
            m21: self.m21 + k,
            m31: self.m31 + k,
    ...
    #[inline(always)]
    fn cmpy(ref self: Matrix5x3<T>, alpha: T, a: Matrix5x3<T>, b: Matrix5x3<T>, beta: T) {
        self =
            Matrix5x3 {
    ...
    #[inline(always)]
    fn cdpy(ref self: Matrix5x3<T>, alpha: T, a: Matrix5x3<T>, b: Matrix5x3<T>, beta: T) {
        self =
            Matrix5x3 {
    ...
    fn iamax_full(self: Matrix5x3<T>) -> (usize, usize) {
    ...
    #[inline(always)]
    fn icamax_full(self: Matrix5x3<T>) -> (usize, usize) {
    ...
    fn dot(self: Matrix5x3<T>, rhs: Matrix5x3<T>) -> T {
    ...
    /// `norm_squared`.
    fn norm_squared(self: Matrix5x3<T>) -> T {
        ...
        R::wide_rescale(R::wide_add_prod(w, self.m53, self.m53))
    }
    ...
    fn norm(self: Matrix5x3<T>) -> T {
        ...
        let w = R::wide_add_prod(w, self.m33, self.m33);
        let w = R::wide_add_prod(w, self.m43, self.m43);
        R::wide_sqrt(R::wide_add_prod(w, self.m53, self.m53))
    }

    /// Alias of `norm_squared`. Upstream: `magnitude_squared`.
    #[inline(always)]
    fn magnitude_squared(self: Matrix5x3<T>) -> T {
        Self::norm_squared(self)
    }

    /// Alias of `norm`. Upstream: `magnitude`.
    #[inline(always)]
    fn magnitude(self: Matrix5x3<T>) -> T {
        Self::norm(self)
    }
    ...
    fn metric_distance(self: Matrix5x3<T>, rhs: Matrix5x3<T>) -> T {
        ...
        R::wide_sqrt(R::wide_add_prod(w, self.m53 - rhs.m53, self.m53 - rhs.m53))
    }
    ...
    fn unscale(self: Matrix5x3<T>, k: T) -> Matrix5x3<T> {
        ...
        let (m52, m13, m23, m33, m43, m53) = R::div6(
            self.m52, self.m13, self.m23, self.m33, self.m43, self.m53, k,
        );
        Matrix5x3 { m11, m21, m31, m41, m51, m12, m22, m32, m42, m52, m13, m23, m33, m43, m53 }
    }
    ...
    fn normalize(self: Matrix5x3<T>) -> Matrix5x3<T> {
    ...
    fn try_normalize(self: Matrix5x3<T>, min_norm: T) -> Option<Matrix5x3<T>> {
    ...
    /// `cap_magnitude`.
    fn cap_magnitude(self: Matrix5x3<T>, max: T) -> Matrix5x3<T> {
        let n = Self::norm(self);
        if n <= max {
            self
        } else {
    ...
    fn try_set_magnitude(ref self: Matrix5x3<T>, magnitude: T, min_magnitude: T) {
        let n = Self::norm(self);
        if n > min_magnitude {
    ...
    #[inline(always)]
    fn one_norm(self: Matrix5x3<T>) -> T {
        R::max(
            R::max(
                R::abs(self.m11)
                    + R::abs(self.m21)
    ...
    /// The conjugate transpose, a `Matrix3x5`: the transpose for a real scalar. Exact. Upstream:
    /// `adjoint`.
    #[inline(always)]
    fn adjoint(self: Matrix5x3<T>) -> Matrix3x5<T> {
        Self::transpose(self)
    }

    /// Alias of `adjoint` (deprecated upstream). Upstream: `conjugate_transpose`.
    #[inline(always)]
    fn conjugate_transpose(self: Matrix5x3<T>) -> Matrix3x5<T> {
        Self::transpose(self)
    }

    /// The component-wise conjugate: `self` for a real scalar. Upstream: `conjugate`.
    #[inline(always)]
    fn conjugate(self: Matrix5x3<T>) -> Matrix5x3<T> {
        self
    }

    /// `self / r` = `self * rᵀ` (the inverse of a rotation is its transpose), a `Matrix5x3`: each
    ...
    fn div_rotation(self: Matrix5x3<T>, r: Rotation3<T>) -> Matrix5x3<T> {
        Matrix5x3 {
            m11: R::sum_prod3(
    ...
    fn cast<U, +Into<T, U>, +Drop<U>>(self: Matrix5x3<T>) -> Matrix5x3<U> {
        Matrix5x3 {
            m11: self.m11.into(),
            m21: self.m21.into(),
            m31: self.m31.into(),
    ...
    fn try_cast<U, +TryInto<T, U>, +Drop<U>>(self: Matrix5x3<T>) -> Option<Matrix5x3<U>> {
    ...
    /// (DESIGN D3).
    #[inline(always)]
    fn relative_eq(self: Matrix5x3<T>, other: Matrix5x3<T>, epsilon: u64, max_relative: T) -> bool {
    ...
    #[inline(always)]
    fn ulps_eq(self: Matrix5x3<T>, other: Matrix5x3<T>, epsilon: u64, max_ulps: u32) -> bool {
    ...
    /// The 5x3 matrix of `f(x)` for every component `x` (called in column-major order). `f` is any
    ...
    /// The 5x3 matrix of `f(i, j, x)` for every component `x` at row `i`, column `j` (0-based,
    ...
    /// The 5x3 matrix of `f(a, b)` for the components `a` of `self` and `b` of `rhs` at the same
    ...
    fn zip_map<
        ...
        +Drop<Func::Output>,
    >(
        self: Matrix5x3<T>, rhs: Matrix5x3<T2>, f: F,
    ) -> Matrix5x3<Func::Output> {
        Matrix5x3 {
    ...
    /// The 5x3 matrix of `f(a, b, c)` for the components of `self`, `b` and `c` at the same
    /// position. `f` is any closure or `Fn` value; Cairo closures take their arguments by value and
    ...
    fn zip_zip_map<
        ...
        +Drop<Func::Output>,
    >(
        self: Matrix5x3<T>, b: Matrix5x3<T2>, c: Matrix5x3<T3>, f: F,
    ) -> Matrix5x3<Func::Output> {
        Matrix5x3 {
    ...
    >(
        self: Matrix5x3<T>, rhs: Matrix5x3<T2>, init: Acc, f: F,
    ) -> Acc {
    ...
    fn zip_apply<
        ...
        +Into<Func::Output, T>,
    >(
        ref self: Matrix5x3<T>, rhs: Matrix5x3<T2>, f: F,
    ) {
        self =
            Matrix5x3 {
    ...
    fn zip_zip_apply<
        ...
        +Into<Func::Output, T>,
    >(
        ref self: Matrix5x3<T>, b: Matrix5x3<T2>, c: Matrix5x3<T3>, f: F,
    ) {
        self =
            Matrix5x3 {
    ...
    #[inline(always)]
    fn fill(ref self: Matrix5x3<T>, val: T) {
        self =
            Matrix5x3 {
                m11: val,
                m21: val,
    ...
    #[inline(always)]
    fn fill_diagonal(ref self: Matrix5x3<T>, val: T) {
        self =
            Matrix5x3 {
                m11: val,
                m21: self.m21,
    ...
    #[inline(always)]
    fn fill_with_identity(ref self: Matrix5x3<T>) {
        self =
            Matrix5x3 {
                m11: R::one(),
                m21: R::zero(),
    ...
    #[inline(always)]
    fn fill_row(ref self: Matrix5x3<T>, i: usize, val: T) {
        self = match i {
            0 => Matrix5x3 {
                m11: val,
                m21: self.m21,
    ...
    #[inline(always)]
    fn fill_column(ref self: Matrix5x3<T>, j: usize, val: T) {
        self = match j {
            0 => Matrix5x3 {
                m11: val,
                m21: val,
    ...
    #[inline(always)]
    fn fill_lower_triangle(ref self: Matrix5x3<T>, val: T, shift: usize) {
        self = match shift {
            0 => Matrix5x3 {
                m11: val,
                m21: val,
    ...
    #[inline(always)]
    fn fill_upper_triangle(ref self: Matrix5x3<T>, val: T, shift: usize) {
        self = match shift {
            0 => Matrix5x3 {
                m11: val,
                m21: self.m21,
    ...
    #[inline(always)]
    fn set_row(ref self: Matrix5x3<T>, i: usize, row: RowVector3<T>) {
        self = match i {
            0 => Matrix5x3 {
                m11: row.x,
                m21: self.m21,
    ...
    #[inline(always)]
    fn set_column(ref self: Matrix5x3<T>, j: usize, column: Vector5<T>) {
        self = match j {
            0 => Matrix5x3 {
                m11: column.x,
                m21: column.y,
    ...
    #[inline(always)]
    fn set_diagonal(ref self: Matrix5x3<T>, diag: Vector3<T>) {
        self =
            Matrix5x3 {
                m11: diag.x,
                m21: self.m21,
    ...
    #[inline(always)]
    fn set_partial_diagonal(ref self: Matrix5x3<T>, diag: Span<T>) {
        let len = diag.len();
        self =
            Matrix5x3 {
                m11: if len > 0 {
    ...
    /// Sets `self` to `other` (a `Matrix5x3`: upstream requires the same shape). Upstream:
    /// `copy_from`.
    #[inline(always)]
    fn copy_from(ref self: Matrix5x3<T>, other: Matrix5x3<T>) {
        self = other;
    }
    ...
    /// (`&[T]`).
    #[inline(always)]
    fn copy_from_slice(ref self: Matrix5x3<T>, slice: Span<T>) {
        self = Self::from_column_slice(slice);
    }

    /// Sets `self` to the transpose of `other`, a `Matrix3x5`. Exact. Upstream: `tr_copy_from`.
    #[inline(always)]
    fn tr_copy_from(ref self: Matrix5x3<T>, other: Matrix3x5<T>) {
        self =
            Matrix5x3 {
                m11: other.m11,
                m21: other.m12,
    ...
    #[inline]
    fn swap(ref self: Matrix5x3<T>, row_cols1: (usize, usize), row_cols2: (usize, usize)) {
        let a = MatrixIndex::index(self, row_cols1);
        let b = MatrixIndex::index(self, row_cols2);
        self =
            Matrix5x3EditTrait::replace(
                Matrix5x3EditTrait::replace(self, row_cols1, b), row_cols2, a,
            );
    }
    ...
    /// benchmark.
    #[inline]
    fn swap_rows(ref self: Matrix5x3<T>, irow1: usize, irow2: usize) {
        let a = Matrix5x3EditTrait::row_at(self, irow1);
        let b = Matrix5x3EditTrait::row_at(self, irow2);
    ...
    #[inline]
    fn swap_columns(ref self: Matrix5x3<T>, icol1: usize, icol2: usize) {
        let a = Matrix5x3EditTrait::column_at(self, icol1);
        let b = Matrix5x3EditTrait::column_at(self, icol2);
    ...
    #[inline(always)]
    fn neg_mut(ref self: Matrix5x3<T>) {
        self = -self;
    }
    ...
    /// `scale_mut`.
    #[inline(always)]
    fn scale_mut(ref self: Matrix5x3<T>, k: T) {
    ...
    #[inline(always)]
    fn unscale_mut(ref self: Matrix5x3<T>, k: T) {
    ...
    #[inline(always)]
    fn normalize_mut(ref self: Matrix5x3<T>) -> T {
        let n = Self::norm(self);
    ...
    #[inline(always)]
    fn try_normalize_mut(ref self: Matrix5x3<T>, min_norm: T) -> Option<T> {
        let n = Self::norm(self);
        if n <= min_norm {
            return None;
        }
    ...
    #[inline(always)]
    fn set_magnitude(ref self: Matrix5x3<T>, magnitude: T) {
        let n = Self::norm(self);
        self = Self::scale(self, R::div(magnitude, n));
    }
    ...
    /// `conjugate_mut`.
    #[inline(always)]
    fn conjugate_mut(ref self: Matrix5x3<T>) {
        self = Self::conjugate(self);
    }

    /// Writes the transpose of `self` into `out`, a `Matrix3x5`. Exact. Upstream: `transpose_to`.
    #[inline(always)]
    fn transpose_to(self: Matrix5x3<T>, ref out: Matrix3x5<T>) {
        out = Self::transpose(self);
    }

    /// Writes the adjoint of `self` (its transpose for a real scalar) into `out`, a `Matrix3x5`.
    /// Exact. Upstream: `adjoint_to`.
    #[inline(always)]
    fn adjoint_to(self: Matrix5x3<T>, ref out: Matrix3x5<T>) {
        out = Self::transpose(self);
    }

    /// Writes the adjoint of `self` (deprecated upstream alias of `adjoint_to`) into `out`, a
    /// `Matrix3x5`. Exact. Upstream: `conjugate_transpose_to`.
    #[inline(always)]
    fn conjugate_transpose_to(self: Matrix5x3<T>, ref out: Matrix3x5<T>) {
        out = Self::transpose(self);
    }

    /// Writes the sum `self + rhs` into `out`. Exact; panics on overflow. Upstream: `add_to`.
    #[inline(always)]
    fn add_to(self: Matrix5x3<T>, rhs: Matrix5x3<T>, ref out: Matrix5x3<T>) {
        out = self + rhs;
    }
    ...
    /// `sub_to`.
    #[inline(always)]
    fn sub_to(self: Matrix5x3<T>, rhs: Matrix5x3<T>, ref out: Matrix5x3<T>) {
        out = self - rhs;
    }
    ...
    #[inline]
    fn apply_norm<N, +Drop<N>, impl Nm: Norm<N, Matrix5x3<T>, T>>(
        self: Matrix5x3<T>, norm: N,
    ) -> T {
        Nm::norm(@norm, self)
    }
    ...
    #[inline]
    fn apply_metric_distance<N, +Drop<N>, impl Nm: Norm<N, Matrix5x3<T>, T>>(
        self: Matrix5x3<T>, rhs: Matrix5x3<T>, norm: N,
    ) -> T {
    ...
    #[inline(always)]
    fn nrows(self: Matrix5x3<T>) -> usize {
        5
    }

    /// The number of columns, 3. Upstream: `ncols`.
    #[inline(always)]
    fn ncols(self: Matrix5x3<T>) -> usize {
        3
    }

    /// `(nrows, ncols)`, `(5, 3)`. Upstream: `shape`.
    #[inline(always)]
    fn shape(self: Matrix5x3<T>) -> (usize, usize) {
        (5, 3)
    }

    /// Whether the shape is square: `false`. Upstream: `is_square`.
    #[inline(always)]
    fn is_square(self: Matrix5x3<T>) -> bool {
        false
    }
    ...
    #[inline(always)]
    fn vector_to_matrix_index(self: Matrix5x3<T>, i: usize) -> (usize, usize) {
    ...
    #[inline(always)]
    fn row(self: Matrix5x3<T>, i: usize) -> RowVector3<T> {
        Matrix5x3EditTrait::row_at(self, i)
    }
    ...
    #[inline(always)]
    fn column(self: Matrix5x3<T>, j: usize) -> Vector5<T> {
        Matrix5x3EditTrait::column_at(self, j)
    }
    ...
    #[inline(always)]
    fn upper_triangle(self: Matrix5x3<T>) -> Matrix5x3<T> {
        Matrix5x3 {
            m11: self.m11,
            m21: R::zero(),
            m31: R::zero(),
    ...
    #[inline(always)]
    fn lower_triangle(self: Matrix5x3<T>) -> Matrix5x3<T> {
        Matrix5x3 {
            m11: self.m11,
            m21: self.m21,
            m31: self.m31,
    ...
    /// The 5x3 matrix whose 5 rows are the given vectors, each a `Vector3` of the row's 3
    ...
    #[inline(always)]
    fn from_rows(
        r1: Vector3<T>, r2: Vector3<T>, r3: Vector3<T>, r4: Vector3<T>, r5: Vector3<T>,
    ) -> Matrix5x3<T> {
        Matrix5x3 {
            m11: r1.x,
            m21: r2.x,
    ...
    /// The 5x3 matrix whose 3 columns are the given `Vector5`s. Exact. Upstream: `from_columns` (a
    /// slice of column vectors).
    #[inline(always)]
    fn from_columns(c1: Vector5<T>, c2: Vector5<T>, c3: Vector5<T>) -> Matrix5x3<T> {
        Matrix5x3 {
            m11: c1.x,
            m21: c1.y,
            m31: c1.z,
    ...
    #[inline(always)]
    fn is_orthogonal(self: Matrix5x3<T>, ulps: u64) -> bool {
        Matrix3Trait::is_identity(MatrixTrMul::tr_mul(self, self), ulps)
    }

    /// `self` with a row of `val` inserted at index `i` (`i <= 5`), a `Matrix6x3`. Panics with
    /// `nalgebra: index out of bounds` for `i > 5`. Upstream: `insert_row`.
    fn insert_row(self: Matrix5x3<T>, i: usize, val: T) -> Matrix6x3<T> {
        match i {
            0 => Matrix6x3 {
                m11: val,
                m21: self.m11,
    ...
    /// `self` with a column of `val` inserted at index `i` (`i <= 3`), a `Matrix5x4`. Panics with
    /// `nalgebra: index out of bounds` for `i > 3`. Upstream: `insert_column`.
    fn insert_column(self: Matrix5x3<T>, i: usize, val: T) -> Matrix5x4<T> {
        match i {
            0 => Matrix5x4 {
                m11: val,
                m21: val,
    ...
    /// `self` without its row `i`, a `Matrix4x3`. Panics with `nalgebra: index out of bounds` for
    /// `i >= 5`. Upstream: `remove_row`.
    #[inline(always)]
    fn remove_row(self: Matrix5x3<T>, i: usize) -> Matrix4x3<T> {
        match i {
            0 => Matrix4x3 {
                m11: self.m21,
                m21: self.m31,
    ...
    /// `self` without its column `i`, a `Matrix5x2`. Panics with `nalgebra: index out of bounds`
    /// for `i >= 3`. Upstream: `remove_column`.
    #[inline(always)]
    fn remove_column(self: Matrix5x3<T>, i: usize) -> Matrix5x2<T> {
        match i {
            0 => Matrix5x2 {
                m11: self.m12,
                m21: self.m22,
...
/// The operations of `Matrix5x3<T>` that need `Transcendental` (inverse trigonometry, `exp`, `ln`):
/// a scalar may implement `Real` only.
#[generate_trait]
pub impl Matrix5x3AngleImpl<
    T,
    impl R: Real<T>,
...
> of Matrix5x3AngleTrait<T> {
    ...
    fn angle(self: Matrix5x3<T>, other: Matrix5x3<T>) -> T {
        let n1 = Matrix5x3Trait::norm(self);
        let n2 = Matrix5x3Trait::norm(other);
        if n1 == R::zero() || n2 == R::zero() {
            return R::zero();
        }
        let u = Matrix5x3Trait::unscale(self, n1);
        let v = Matrix5x3Trait::unscale(other, n2);
        let half = Tr::atan2(Matrix5x3Trait::metric_distance(u, v), Matrix5x3Trait::norm(u + v));
        half + half
    }
    ...
    /// Upstream: `lp_norm`.
    fn lp_norm(self: Matrix5x3<T>, p: i32) -> T {
        if p < 1 {
        ...
        if p == 2 {
            return Matrix5x3Trait::norm(self);
        }
        let m = Matrix5x3Trait::amax(self);
        if m == R::zero() {
            return R::zero();
        }
        let r = Matrix5x3Trait::unscale(Matrix5x3Trait::abs(self), m);
...
pub impl Matrix5x3MatrixIndexLinear<T, +Copy<T>, +Drop<T>> of MatrixIndex<Matrix5x3<T>, usize> {
    type Output = T;
    #[inline(always)]
    fn get(self: Matrix5x3<T>, index: usize) -> Option<T> {
        match index {
    ...
    #[inline(always)]
    fn index(self: Matrix5x3<T>, index: usize) -> T {
        match index {
            0 => self.m11,
            1 => self.m21,
            2 => self.m31,
...
pub impl Matrix5x3IndexLinear<T, +Copy<T>, +Drop<T>> of IndexView<Matrix5x3<T>, usize> {
    type Target = T;
    #[inline(always)]
    fn index(self: @Matrix5x3<T>, index: usize) -> T {
        match index {
...
pub impl Matrix5x3MatrixIndexPair<
    T, +Copy<T>, +Drop<T>,
> of MatrixIndex<Matrix5x3<T>, (usize, usize)> {
    type Output = T;
    #[inline(always)]
    fn get(self: Matrix5x3<T>, index: (usize, usize)) -> Option<T> {
        let (i, j) = index;
        match j {
            0 => match i {
                0 => Option::Some(self.m11),
    ...
    #[inline(always)]
    fn index(self: Matrix5x3<T>, index: (usize, usize)) -> T {
        let (i, j) = index;
        match j {
            0 => match i {
                0 => self.m11,
...
pub impl Matrix5x3IndexPair<T, +Copy<T>, +Drop<T>> of IndexView<Matrix5x3<T>, (usize, usize)> {
    type Target = T;
    #[inline(always)]
    fn index(self: @Matrix5x3<T>, index: (usize, usize)) -> T {
        let (i, j) = index;
...
pub impl Matrix5x3PartialOrd<T, +PartialOrd<T>, +Copy<T>, +Drop<T>> of PartialOrd<Matrix5x3<T>> {
    #[inline(always)]
    fn lt(lhs: Matrix5x3<T>, rhs: Matrix5x3<T>) -> bool {
        lhs.m11 < rhs.m11
            && lhs.m21 < rhs.m21
            && lhs.m31 < rhs.m31
            && lhs.m41 < rhs.m41
    ...
    #[inline(always)]
    fn le(lhs: Matrix5x3<T>, rhs: Matrix5x3<T>) -> bool {
        lhs.m11 <= rhs.m11
            && lhs.m21 <= rhs.m21
            && lhs.m31 <= rhs.m31
            && lhs.m41 <= rhs.m41
    ...
    #[inline(always)]
    fn gt(lhs: Matrix5x3<T>, rhs: Matrix5x3<T>) -> bool {
        lhs.m11 > rhs.m11
            && lhs.m21 > rhs.m21
            && lhs.m31 > rhs.m31
            && lhs.m41 > rhs.m41
    ...
    #[inline(always)]
    fn ge(lhs: Matrix5x3<T>, rhs: Matrix5x3<T>) -> bool {
        lhs.m11 >= rhs.m11
            && lhs.m21 >= rhs.m21
            && lhs.m31 >= rhs.m31
            && lhs.m41 >= rhs.m41
...
/// for Matrix`.
pub impl Matrix5x3Bounded<T, +Bounded<T>, +Drop<T>> of Bounded<Matrix5x3<T>> {
    const MIN: Matrix5x3<T> = Matrix5x3 {
        m11: Bounded::<T>::MIN,
        m21: Bounded::<T>::MIN,
        m31: Bounded::<T>::MIN,
        m41: Bounded::<T>::MIN,
    ...
    const MAX: Matrix5x3<T> = Matrix5x3 {
        m11: Bounded::<T>::MAX,
        m21: Bounded::<T>::MAX,
        m31: Bounded::<T>::MAX,
        m41: Bounded::<T>::MAX,
...
/// The 5x3 matrix of the given COLUMNS (`[[m11, m21, ..], [m12, ..], ..]`). Upstream: `From<[[T;
/// R]; C]>`.
pub impl Matrix5x3FromColumnArrays<T, +Drop<T>> of Into<[[T; 5]; 3], Matrix5x3<T>> {
    #[inline(always)]
    fn into(self: [[T; 5]; 3]) -> Matrix5x3<T> {
        let [c0, c1, c2] = self;
...
/// The columns of the 5x3 matrix as nested arrays (`[[m11, m21, ..], [m12, ..], ..]`). Upstream:
/// `Into<[[T; R]; C]>`.
pub impl Matrix5x3IntoColumnArrays<T, +Drop<T>> of Into<Matrix5x3<T>, [[T; 5]; 3]> {
    #[inline(always)]
    fn into(self: Matrix5x3<T>) -> [[T; 5]; 3] {
        let Matrix5x3 {
...
pub impl Matrix5x3MulAssignScalar<T, +Mul<T>, +Copy<T>, +Drop<T>> of MulAssign<Matrix5x3<T>, T> {
    #[inline(always)]
    fn mul_assign(ref self: Matrix5x3<T>, rhs: T) {
        self =
            Matrix5x3 {
                m11: self.m11 * rhs,
                m21: self.m21 * rhs,
...
pub impl Matrix5x3DivAssignScalar<
    T, impl R: Real<T>, +Copy<T>, +Drop<T>,
> of DivAssign<Matrix5x3<T>, T> {
    fn div_assign(ref self: Matrix5x3<T>, rhs: T) {
        let (m11, m21, m31, m41, m51, m12, m22, m32, m42) = R::div9(
            self.m11,
            self.m21,
            self.m31,
        ...
        let (m52, m13, m23, m33, m43, m53) = R::div6(
            self.m52, self.m13, self.m23, self.m33, self.m43, self.m53, rhs,
        );
        self =
            Matrix5x3 { m11, m21, m31, m41, m51, m12, m22, m32, m42, m52, m13, m23, m33, m43, m53 };
    }
...
/// `self * r`, a `Matrix5x3`: the product with the rotation matrix of `r`, each component one fused
/// `sum_prod3` (floored once). Panics on overflow. Upstream: `Mul<Rotation3> for Matrix` (`m * r`).
pub impl Matrix5x3MulRotation3<
    T, impl R: Real<T>, +Mul<T>, +Copy<T>, +Drop<T>,
> of MatrixMul<Matrix5x3<T>, Rotation3<T>> {
    type Output = Matrix5x3<T>;

    fn mul_mat(self: Matrix5x3<T>, rhs: Rotation3<T>) -> Matrix5x3<T> {
        Matrix5x3 {
            m11: R::sum_prod3(
...
#[generate_trait]
impl Matrix5x3EditImpl<T, +Copy<T>, +Drop<T>> of Matrix5x3EditTrait<T> {
    /// `self` with the component at `index` (`(row, column)`) replaced by `v`; panics out of
    /// bounds.
    #[inline(always)]
    fn replace(self: Matrix5x3<T>, index: (usize, usize), v: T) -> Matrix5x3<T> {
        let (i, j) = index;
        match j {
            0 => match i {
                0 => Matrix5x3 {
    ...
    #[inline(always)]
    fn row_at(self: Matrix5x3<T>, i: usize) -> RowVector3<T> {
        match i {
    ...
    #[inline(always)]
    fn column_at(self: Matrix5x3<T>, j: usize) -> Vector5<T> {
        match j {
...
/// The 1 consecutive rows of a `Matrix5x3` as a `RowVector3`. Upstream: `fixed_rows::<1>`, `rows(i,
...
> of FixedRows<Matrix5x3<T>, RowVector3<T>> {
    ...
    #[inline(always)]
    fn rows(self: Matrix5x3<T>, first_row: usize, nrows: usize) -> RowVector3<T> {
        if nrows != 1 {
    ...
    #[inline(always)]
    fn rows_range(self: Matrix5x3<T>, rows: Range<usize>) -> RowVector3<T> {
...
/// The 2 consecutive rows of a `Matrix5x3` as a `Matrix2x3`. Upstream: `fixed_rows::<2>`, `rows(i,
...
> of FixedRows<Matrix5x3<T>, Matrix2x3<T>> {
    ...
    #[inline(always)]
    fn rows(self: Matrix5x3<T>, first_row: usize, nrows: usize) -> Matrix2x3<T> {
        if nrows != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Matrix5x3<T>, rows: Range<usize>) -> Matrix2x3<T> {
        let Range { start, end } = rows;
        if end != start + 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 3 consecutive rows of a `Matrix5x3` as a `Matrix3`. Upstream: `fixed_rows::<3>`, `rows(i,
...
pub impl Matrix5x3FixedRowsMatrix3<T, +Copy<T>, +Drop<T>> of FixedRows<Matrix5x3<T>, Matrix3<T>> {
    ...
    #[inline(always)]
    fn rows(self: Matrix5x3<T>, first_row: usize, nrows: usize) -> Matrix3<T> {
        if nrows != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Matrix5x3<T>, rows: Range<usize>) -> Matrix3<T> {
        let Range { start, end } = rows;
        if end != start + 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 4 consecutive rows of a `Matrix5x3` as a `Matrix4x3`. Upstream: `fixed_rows::<4>`, `rows(i,
...
> of FixedRows<Matrix5x3<T>, Matrix4x3<T>> {
    ...
    #[inline(always)]
    fn rows(self: Matrix5x3<T>, first_row: usize, nrows: usize) -> Matrix4x3<T> {
        if nrows != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Matrix5x3<T>, rows: Range<usize>) -> Matrix4x3<T> {
        let Range { start, end } = rows;
        if end != start + 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 5 consecutive rows of a `Matrix5x3` as a `Matrix5x3`. Upstream: `fixed_rows::<5>`, `rows(i,
...
> of FixedRows<Matrix5x3<T>, Matrix5x3<T>> {
    ...
    #[inline(always)]
    fn rows(self: Matrix5x3<T>, first_row: usize, nrows: usize) -> Matrix5x3<T> {
        if nrows != 5 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_rows(self, first_row)
    ...
    #[inline(always)]
    fn rows_range(self: Matrix5x3<T>, rows: Range<usize>) -> Matrix5x3<T> {
        let Range { start, end } = rows;
        if end != start + 5 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 1 consecutive columns of a `Matrix5x3` as a `Vector5`. Upstream: `fixed_columns::<1>`,
...
> of FixedColumns<Matrix5x3<T>, Vector5<T>> {
    ...
    #[inline(always)]
    fn columns(self: Matrix5x3<T>, first_col: usize, ncols: usize) -> Vector5<T> {
        if ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
    ...
    #[inline(always)]
    fn columns_range(self: Matrix5x3<T>, cols: Range<usize>) -> Vector5<T> {
...
/// The 2 consecutive columns of a `Matrix5x3` as a `Matrix5x2`. Upstream: `fixed_columns::<2>`,
...
> of FixedColumns<Matrix5x3<T>, Matrix5x2<T>> {
    ...
    #[inline(always)]
    fn columns(self: Matrix5x3<T>, first_col: usize, ncols: usize) -> Matrix5x2<T> {
        if ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_columns(self, first_col)
    ...
    #[inline(always)]
    fn columns_range(self: Matrix5x3<T>, cols: Range<usize>) -> Matrix5x2<T> {
        let Range { start, end } = cols;
        if end != start + 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 3 consecutive columns of a `Matrix5x3` as a `Matrix5x3`. Upstream: `fixed_columns::<3>`,
...
> of FixedColumns<Matrix5x3<T>, Matrix5x3<T>> {
    ...
    #[inline(always)]
    fn columns(self: Matrix5x3<T>, first_col: usize, ncols: usize) -> Matrix5x3<T> {
        if ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_columns(self, first_col)
    ...
    #[inline(always)]
    fn columns_range(self: Matrix5x3<T>, cols: Range<usize>) -> Matrix5x3<T> {
        let Range { start, end } = cols;
        if end != start + 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 1x1 blocks of a `Matrix5x3` as a `Matrix1`. Upstream: `fixed_view::<1, 1>`, `view`, and the
...
pub impl Matrix5x3FixedViewMatrix1<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x3<T>, Matrix1<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix1<T> {
        let (irow, icol) = start;
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Matrix1<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix1<T> {
        Self::view(self, start, shape)
    }
}

/// The 1x2 blocks of a `Matrix5x3` as a `RowVector2`. Upstream: `fixed_view::<1, 2>`, `view`, and
...
> of FixedView<Matrix5x3<T>, RowVector2<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 1 || ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> RowVector2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector2<T> {
        Self::view(self, start, shape)
    }
}

/// The 1x3 blocks of a `Matrix5x3` as a `RowVector3`. Upstream: `fixed_view::<1, 3>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x3<T>, RowVector3<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 1 || ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> RowVector3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector3<T> {
        Self::view(self, start, shape)
    }
}

/// The 2x1 blocks of a `Matrix5x3` as a `Vector2`. Upstream: `fixed_view::<2, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x3FixedViewVector2<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x3<T>, Vector2<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Vector2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 2 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Vector2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Vector2<T> {
        Self::view(self, start, shape)
    }
}

/// The 2x2 blocks of a `Matrix5x3` as a `Matrix2`. Upstream: `fixed_view::<2, 2>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x3FixedViewMatrix2<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x3<T>, Matrix2<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 2 || ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Matrix2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix2<T> {
        Self::view(self, start, shape)
    }
}

/// The 2x3 blocks of a `Matrix5x3` as a `Matrix2x3`. Upstream: `fixed_view::<2, 3>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x3<T>, Matrix2x3<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix2x3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 2 || ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Matrix2x3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix2x3<T> {
        Self::view(self, start, shape)
    }
}

/// The 3x1 blocks of a `Matrix5x3` as a `Vector3`. Upstream: `fixed_view::<3, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x3FixedViewVector3<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x3<T>, Vector3<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Vector3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 3 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Vector3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Vector3<T> {
        Self::view(self, start, shape)
    }
}

/// The 3x2 blocks of a `Matrix5x3` as a `Matrix3x2`. Upstream: `fixed_view::<3, 2>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x3<T>, Matrix3x2<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix3x2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 3 || ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Matrix3x2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix3x2<T> {
        Self::view(self, start, shape)
    }
}

/// The 3x3 blocks of a `Matrix5x3` as a `Matrix3`. Upstream: `fixed_view::<3, 3>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x3FixedViewMatrix3<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x3<T>, Matrix3<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 3 || ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Matrix3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix3<T> {
        Self::view(self, start, shape)
    }
}

/// The 4x1 blocks of a `Matrix5x3` as a `Vector4`. Upstream: `fixed_view::<4, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x3FixedViewVector4<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x3<T>, Vector4<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Vector4<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 4 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Vector4<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Vector4<T> {
        Self::view(self, start, shape)
    }
}

/// The 4x2 blocks of a `Matrix5x3` as a `Matrix4x2`. Upstream: `fixed_view::<4, 2>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x3<T>, Matrix4x2<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix4x2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 4 || ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Matrix4x2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix4x2<T> {
        Self::view(self, start, shape)
    }
}

/// The 4x3 blocks of a `Matrix5x3` as a `Matrix4x3`. Upstream: `fixed_view::<4, 3>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x3<T>, Matrix4x3<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix4x3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 4 || ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Matrix4x3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix4x3<T> {
        Self::view(self, start, shape)
    }
}

/// The 5x1 blocks of a `Matrix5x3` as a `Vector5`. Upstream: `fixed_view::<5, 1>`, `view`, and the
/// deprecated `fixed_slice` / `slice`.
pub impl Matrix5x3FixedViewVector5<T, +Copy<T>, +Drop<T>> of FixedView<Matrix5x3<T>, Vector5<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Vector5<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 5 || ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Vector5<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Vector5<T> {
        Self::view(self, start, shape)
    }
}

/// The 5x2 blocks of a `Matrix5x3` as a `Matrix5x2`. Upstream: `fixed_view::<5, 2>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x3<T>, Matrix5x2<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix5x2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 5 || ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Matrix5x2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix5x2<T> {
        Self::view(self, start, shape)
    }
}

/// The 5x3 blocks of a `Matrix5x3` as a `Matrix5x3`. Upstream: `fixed_view::<5, 3>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<Matrix5x3<T>, Matrix5x3<T>> {
    ...
    #[inline(always)]
    fn view(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix5x3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 5 || ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: Matrix5x3<T>, irow: usize, icol: usize) -> Matrix5x3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: Matrix5x3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix5x3<T> {
        Self::view(self, start, shape)
    }
}

/// The first 1 components of a row of a `Matrix5x3` as a `Matrix1`. Upstream: `row_part` (`n = 1`).
pub impl Matrix5x3RowPartMatrix1<T, +Copy<T>, +Drop<T>> of RowPart<Matrix5x3<T>, Matrix1<T>> {
    #[inline(always)]
    fn row_part(self: Matrix5x3<T>, i: usize, n: usize) -> Matrix1<T> {
        if n != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The first 2 components of a row of a `Matrix5x3` as a `RowVector2`. Upstream: `row_part` (`n =
/// 2`).
pub impl Matrix5x3RowPartRowVector2<T, +Copy<T>, +Drop<T>> of RowPart<Matrix5x3<T>, RowVector2<T>> {
    #[inline(always)]
    fn row_part(self: Matrix5x3<T>, i: usize, n: usize) -> RowVector2<T> {
        if n != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, i, 0)
...
/// The first 3 components of a row of a `Matrix5x3` as a `RowVector3`. Upstream: `row_part` (`n =
/// 3`).
pub impl Matrix5x3RowPartRowVector3<T, +Copy<T>, +Drop<T>> of RowPart<Matrix5x3<T>, RowVector3<T>> {
    #[inline(always)]
    fn row_part(self: Matrix5x3<T>, i: usize, n: usize) -> RowVector3<T> {
        if n != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, i, 0)
...
/// The first 1 components of a column of a `Matrix5x3` as a `Matrix1`. Upstream: `column_part` (`n
/// = 1`).
pub impl Matrix5x3ColumnPartMatrix1<T, +Copy<T>, +Drop<T>> of ColumnPart<Matrix5x3<T>, Matrix1<T>> {
    #[inline(always)]
    fn column_part(self: Matrix5x3<T>, i: usize, n: usize) -> Matrix1<T> {
        if n != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The first 2 components of a column of a `Matrix5x3` as a `Vector2`. Upstream: `column_part` (`n
/// = 2`).
pub impl Matrix5x3ColumnPartVector2<T, +Copy<T>, +Drop<T>> of ColumnPart<Matrix5x3<T>, Vector2<T>> {
    #[inline(always)]
    fn column_part(self: Matrix5x3<T>, i: usize, n: usize) -> Vector2<T> {
        if n != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
...
/// The first 3 components of a column of a `Matrix5x3` as a `Vector3`. Upstream: `column_part` (`n
/// = 3`).
pub impl Matrix5x3ColumnPartVector3<T, +Copy<T>, +Drop<T>> of ColumnPart<Matrix5x3<T>, Vector3<T>> {
    #[inline(always)]
    fn column_part(self: Matrix5x3<T>, i: usize, n: usize) -> Vector3<T> {
        if n != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
...
/// The first 4 components of a column of a `Matrix5x3` as a `Vector4`. Upstream: `column_part` (`n
/// = 4`).
pub impl Matrix5x3ColumnPartVector4<T, +Copy<T>, +Drop<T>> of ColumnPart<Matrix5x3<T>, Vector4<T>> {
    #[inline(always)]
    fn column_part(self: Matrix5x3<T>, i: usize, n: usize) -> Vector4<T> {
        if n != 4 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
...
/// The first 5 components of a column of a `Matrix5x3` as a `Vector5`. Upstream: `column_part` (`n
/// = 5`).
pub impl Matrix5x3ColumnPartVector5<T, +Copy<T>, +Drop<T>> of ColumnPart<Matrix5x3<T>, Vector5<T>> {
    #[inline(always)]
    fn column_part(self: Matrix5x3<T>, i: usize, n: usize) -> Vector5<T> {
        if n != 5 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, 0, i)
