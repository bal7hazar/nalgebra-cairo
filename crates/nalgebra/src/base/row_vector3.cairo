...
> of RowVector3Trait<T> {
    ...
    /// `self / r` = `self * rᵀ` (the inverse of a rotation is its transpose), a `RowVector3`:
    /// each component one fused `sum_prod3` (floored once). Panics on overflow. Upstream:
    ...
    #[inline(always)]
    fn div_rotation(self: RowVector3<T>, r: Rotation3<T>) -> RowVector3<T> {
        RowVector3 {
            x: R::sum_prod3(self.x, r.matrix.m11, self.y, r.matrix.m12, self.z, r.matrix.m13),
            y: R::sum_prod3(self.x, r.matrix.m21, self.y, r.matrix.m22, self.z, r.matrix.m23),
            z: R::sum_prod3(self.x, r.matrix.m31, self.y, r.matrix.m32, self.z, r.matrix.m33),
        }
    }
    ...
    /// The 3-dimensional row vector of `f(x)` for every component `x` (called in column-major
    ...
    ) -> RowVector3<Func::Output> {
        RowVector3 { x: f(self.x), y: f(self.y), z: f(self.z) }
    }

    /// The 3-dimensional row vector of `f(i, j, x)` for every component `x` at row `i`, column `j`
    ...
    >(
        ...
        RowVector3 { x: f(0, 0, self.x), y: f(0, 1, self.y), z: f(0, 2, self.z) }
    }

    /// The 3-dimensional row vector of `f(a, b)` for the components `a` of `self` and `b` of `rhs`
    ...
    fn zip_map<
        ...
        +Drop<Func::Output>,
    >(
        self: RowVector3<T>, rhs: RowVector3<T2>, f: F,
    ) -> RowVector3<Func::Output> {
        RowVector3 { x: f(self.x, rhs.x), y: f(self.y, rhs.y), z: f(self.z, rhs.z) }
    }

    /// The 3-dimensional row vector of `f(a, b, c)` for the components of `self`, `b` and `c` at
    ...
    fn zip_zip_map<
        ...
        +Drop<Func::Output>,
    >(
        self: RowVector3<T>, b: RowVector3<T2>, c: RowVector3<T3>, f: F,
    ) -> RowVector3<Func::Output> {
        RowVector3 { x: f(self.x, b.x, c.x), y: f(self.y, b.y, c.y), z: f(self.z, b.z, c.z) }
    }
    ...
    fn fold<Acc, F, +Drop<F>, impl Func: core::ops::Fn<F, (Acc, T)>, +Into<Func::Output, Acc>>(
        self: RowVector3<T>, init: Acc, f: F,
    ) -> Acc {
    ...
    >(
        self: RowVector3<T>, init_f: G, f: F,
    ) -> Init::Output {
    ...
    >(
        self: RowVector3<T>, rhs: RowVector3<T2>, init: Acc, f: F,
    ) -> Acc {
    ...
    fn apply<F, +Drop<F>, impl Func: core::ops::Fn<F, (T,)>, +Into<Func::Output, T>>(
        ref self: RowVector3<T>, f: F,
    ) {
        self = RowVector3 { x: f(self.x).into(), y: f(self.y).into(), z: f(self.z).into() };
    }
    ...
    fn apply_into<F, +Drop<F>, impl Func: core::ops::Fn<F, (T,)>, +Into<Func::Output, T>>(
        ...
        RowVector3 { x: f(self.x).into(), y: f(self.y).into(), z: f(self.z).into() }
    }
    ...
    fn zip_apply<
        ...
        +Into<Func::Output, T>,
    >(
        ref self: RowVector3<T>, rhs: RowVector3<T2>, f: F,
    ) {
        self =
            RowVector3 {
    ...
    fn zip_zip_apply<
        ...
        +Into<Func::Output, T>,
    >(
        ref self: RowVector3<T>, b: RowVector3<T2>, c: RowVector3<T3>, f: F,
    ) {
        self =
            RowVector3 {
    ...
    fn fill_with<F, +Drop<F>, impl Func: core::ops::Fn<F, ()>, +Into<Func::Output, T>>(
        ...
        self = RowVector3 { x: f().into(), y: f().into(), z: f().into() };
    }

    /// Sets every component to `val`. Upstream: `fill`.
    #[inline(always)]
    fn fill(ref self: RowVector3<T>, val: T) {
        self = RowVector3 { x: val, y: val, z: val };
    }

    /// Sets the 1 diagonal components to `val`, the others unchanged. Upstream: `fill_diagonal`.
    #[inline(always)]
    fn fill_diagonal(ref self: RowVector3<T>, val: T) {
        self = RowVector3 { x: val, y: self.y, z: self.z };
    }

    /// Sets `self` to the identity: ones on the diagonal, zeros elsewhere (`fill(0)` then
    /// `fill_diagonal(1)`). Upstream: `fill_with_identity`.
    #[inline(always)]
    fn fill_with_identity(ref self: RowVector3<T>) {
        self = RowVector3 { x: R::one(), y: R::zero(), z: R::zero() };
    }
    ...
    #[inline(always)]
    fn fill_row(ref self: RowVector3<T>, i: usize, val: T) {
        self = match i {
            0 => RowVector3 { x: val, y: val, z: val },
    ...
    #[inline(always)]
    fn fill_column(ref self: RowVector3<T>, j: usize, val: T) {
        self = match j {
            0 => RowVector3 { x: val, y: self.y, z: self.z },
            1 => RowVector3 { x: self.x, y: val, z: self.z },
            2 => RowVector3 { x: self.x, y: self.y, z: val },
            _ => core::panic_with_felt252(errors::INDEX_OUT_OF_BOUNDS),
        };
    }
    ...
    #[inline(always)]
    fn fill_lower_triangle(ref self: RowVector3<T>, val: T, shift: usize) {
        self = match shift {
            0 => RowVector3 { x: val, y: self.y, z: self.z },
            _ => self,
        };
    ...
    #[inline(always)]
    fn fill_upper_triangle(ref self: RowVector3<T>, val: T, shift: usize) {
        self = match shift {
            0 => RowVector3 { x: val, y: val, z: val },
            1 => RowVector3 { x: self.x, y: val, z: val },
            2 => RowVector3 { x: self.x, y: self.y, z: val },
            _ => self,
        };
    }
    ...
    #[inline(always)]
    fn set_row(ref self: RowVector3<T>, i: usize, row: RowVector3<T>) {
        self = match i {
            0 => RowVector3 { x: row.x, y: row.y, z: row.z },
            _ => core::panic_with_felt252(errors::INDEX_OUT_OF_BOUNDS),
        };
    }
    ...
    #[inline(always)]
    fn set_column(ref self: RowVector3<T>, j: usize, column: Matrix1<T>) {
        self = match j {
            0 => RowVector3 { x: column.x, y: self.y, z: self.z },
            1 => RowVector3 { x: self.x, y: column.x, z: self.z },
            2 => RowVector3 { x: self.x, y: self.y, z: column.x },
            _ => core::panic_with_felt252(errors::INDEX_OUT_OF_BOUNDS),
        };
    }
    ...
    #[inline(always)]
    fn set_diagonal(ref self: RowVector3<T>, diag: Matrix1<T>) {
        self = RowVector3 { x: diag.x, y: self.y, z: self.z };
    }
    ...
    #[inline(always)]
    fn set_partial_diagonal(ref self: RowVector3<T>, diag: Span<T>) {
        let len = diag.len();
        self = RowVector3 { x: if len > 0 {
            *diag[0]
        } else {
            self.x
        }, y: self.y, z: self.z };
    ...
    /// Sets `self` to `other` (a `RowVector3`: upstream requires the same shape). Upstream:
    /// `copy_from`.
    #[inline(always)]
    fn copy_from(ref self: RowVector3<T>, other: RowVector3<T>) {
        self = other;
    }
    ...
    /// (`&[T]`).
    #[inline(always)]
    fn copy_from_slice(ref self: RowVector3<T>, slice: Span<T>) {
        self = Self::from_column_slice(slice);
    }

    /// Sets `self` to the transpose of `other`, a `Vector3`. Exact. Upstream: `tr_copy_from`.
    #[inline(always)]
    fn tr_copy_from(ref self: RowVector3<T>, other: Vector3<T>) {
        self = RowVector3 { x: other.x, y: other.y, z: other.z };
    }
    ...
    #[inline]
    fn swap(ref self: RowVector3<T>, row_cols1: (usize, usize), row_cols2: (usize, usize)) {
        let a = MatrixIndex::index(self, row_cols1);
        let b = MatrixIndex::index(self, row_cols2);
        self =
            RowVector3EditTrait::replace(
                RowVector3EditTrait::replace(self, row_cols1, b), row_cols2, a,
            );
    }
    ...
    /// benchmark.
    #[inline]
    fn swap_rows(ref self: RowVector3<T>, irow1: usize, irow2: usize) {
        let a = RowVector3EditTrait::row_at(self, irow1);
        let b = RowVector3EditTrait::row_at(self, irow2);
    ...
    #[inline]
    fn swap_columns(ref self: RowVector3<T>, icol1: usize, icol2: usize) {
        let a = RowVector3EditTrait::column_at(self, icol1);
        let b = RowVector3EditTrait::column_at(self, icol2);
    ...
    #[inline(always)]
    fn neg_mut(ref self: RowVector3<T>) {
        self = -self;
    }
    ...
    /// `scale_mut`.
    #[inline(always)]
    fn scale_mut(ref self: RowVector3<T>, k: T) {
    ...
    #[inline(always)]
    fn unscale_mut(ref self: RowVector3<T>, k: T) {
    ...
    #[inline(always)]
    fn normalize_mut(ref self: RowVector3<T>) -> T {
        let n = Self::norm(self);
    ...
    #[inline(always)]
    fn try_normalize_mut(ref self: RowVector3<T>, min_norm: T) -> Option<T> {
        let n = Self::norm(self);
        if n <= min_norm {
            return None;
        }
    ...
    #[inline(always)]
    fn set_magnitude(ref self: RowVector3<T>, magnitude: T) {
        let n = Self::norm(self);
        self = Self::scale(self, R::div(magnitude, n));
    }
    ...
    /// `conjugate_mut`.
    #[inline(always)]
    fn conjugate_mut(ref self: RowVector3<T>) {
        self = Self::conjugate(self);
    }

    /// Writes the transpose of `self` into `out`, a `Vector3`. Exact. Upstream: `transpose_to`.
    #[inline(always)]
    fn transpose_to(self: RowVector3<T>, ref out: Vector3<T>) {
        out = Self::transpose(self);
    }

    /// Writes the adjoint of `self` (its transpose for a real scalar) into `out`, a `Vector3`.
    /// Exact. Upstream: `adjoint_to`.
    #[inline(always)]
    fn adjoint_to(self: RowVector3<T>, ref out: Vector3<T>) {
        out = Self::transpose(self);
    }

    /// Writes the adjoint of `self` (deprecated upstream alias of `adjoint_to`) into `out`, a
    /// `Vector3`. Exact. Upstream: `conjugate_transpose_to`.
    #[inline(always)]
    fn conjugate_transpose_to(self: RowVector3<T>, ref out: Vector3<T>) {
        out = Self::transpose(self);
    }

    /// Writes the sum `self + rhs` into `out`. Exact; panics on overflow. Upstream: `add_to`.
    #[inline(always)]
    fn add_to(self: RowVector3<T>, rhs: RowVector3<T>, ref out: RowVector3<T>) {
        out = self + rhs;
    }
    ...
    /// `sub_to`.
    #[inline(always)]
    fn sub_to(self: RowVector3<T>, rhs: RowVector3<T>, ref out: RowVector3<T>) {
        out = self - rhs;
    }
    ...
    #[inline]
    fn apply_norm<N, +Drop<N>, impl Nm: Norm<N, RowVector3<T>, T>>(
        self: RowVector3<T>, norm: N,
    ) -> T {
        Nm::norm(@norm, self)
    }
    ...
    #[inline]
    fn apply_metric_distance<N, +Drop<N>, impl Nm: Norm<N, RowVector3<T>, T>>(
        self: RowVector3<T>, rhs: RowVector3<T>, norm: N,
    ) -> T {
    ...
    #[inline(always)]
    fn nrows(self: RowVector3<T>) -> usize {
        1
    }

    /// The number of columns, 3. Upstream: `ncols`.
    #[inline(always)]
    fn ncols(self: RowVector3<T>) -> usize {
        3
    }

    /// `(nrows, ncols)`, `(1, 3)`. Upstream: `shape`.
    #[inline(always)]
    fn shape(self: RowVector3<T>) -> (usize, usize) {
        (1, 3)
    }

    /// Whether the shape is square: `false`. Upstream: `is_square`.
    #[inline(always)]
    fn is_square(self: RowVector3<T>) -> bool {
        false
    }
    ...
    #[inline(always)]
    fn vector_to_matrix_index(self: RowVector3<T>, i: usize) -> (usize, usize) {
        (0, i)
    }
    ...
    #[inline(always)]
    fn row(self: RowVector3<T>, i: usize) -> RowVector3<T> {
        RowVector3EditTrait::row_at(self, i)
    }
    ...
    #[inline(always)]
    fn column(self: RowVector3<T>, j: usize) -> Matrix1<T> {
        RowVector3EditTrait::column_at(self, j)
    }
    ...
    #[inline(always)]
    fn upper_triangle(self: RowVector3<T>) -> RowVector3<T> {
    ...
    #[inline(always)]
    fn lower_triangle(self: RowVector3<T>) -> RowVector3<T> {
        RowVector3 { x: self.x, y: R::zero(), z: R::zero() }
    }

    /// The 3-dimensional row vector whose 1 rows are the given vectors, each a `Vector3` of the
    /// row's 3 components (the argument form of the former `Matrix2/3/4::from_rows`, used by
    /// `linalg`). Exact. Upstream: `from_rows` (a slice of row vectors).
    #[inline(always)]
    fn from_rows(r1: Vector3<T>) -> RowVector3<T> {
        RowVector3 { x: r1.x, y: r1.y, z: r1.z }
    }

    /// The 3-dimensional row vector whose 3 columns are the given `Matrix1`s. Exact. Upstream:
    /// `from_columns` (a slice of column vectors).
    #[inline(always)]
    fn from_columns(c1: Matrix1<T>, c2: Matrix1<T>, c3: Matrix1<T>) -> RowVector3<T> {
        RowVector3 { x: c1.x, y: c2.x, z: c3.x }
    }
    ...
    #[inline(always)]
    fn is_orthogonal(self: RowVector3<T>, ulps: u64) -> bool {
        Matrix3Trait::is_identity(MatrixTrMul::tr_mul(self, self), ulps)
    }

    /// `self` with a row of `val` inserted at index `i` (`i <= 1`), a `Matrix2x3`. Panics with
    /// `nalgebra: index out of bounds` for `i > 1`. Upstream: `insert_row`.
    #[inline(always)]
    fn insert_row(self: RowVector3<T>, i: usize, val: T) -> Matrix2x3<T> {
        match i {
            0 => Matrix2x3 { m11: val, m21: self.x, m12: val, m22: self.y, m13: val, m23: self.z },
            1 => Matrix2x3 { m11: self.x, m21: val, m12: self.y, m22: val, m13: self.z, m23: val },
            _ => core::panic_with_felt252(errors::INDEX_OUT_OF_BOUNDS),
        }
    }

    /// `self` with a column of `val` inserted at index `i` (`i <= 3`), a `RowVector4`. Panics with
    /// `nalgebra: index out of bounds` for `i > 3`. Upstream: `insert_column`.
    #[inline(always)]
    fn insert_column(self: RowVector3<T>, i: usize, val: T) -> RowVector4<T> {
        match i {
            0 => RowVector4 { x: val, y: self.x, z: self.y, w: self.z },
            1 => RowVector4 { x: self.x, y: val, z: self.y, w: self.z },
            2 => RowVector4 { x: self.x, y: self.y, z: val, w: self.z },
            3 => RowVector4 { x: self.x, y: self.y, z: self.z, w: val },
            _ => core::panic_with_felt252(errors::INDEX_OUT_OF_BOUNDS),
        }
    }

    /// `self` without its column `i`, a `RowVector2`. Panics with `nalgebra: index out of bounds`
    /// for `i >= 3`. Upstream: `remove_column`.
    #[inline(always)]
    fn remove_column(self: RowVector3<T>, i: usize) -> RowVector2<T> {
        match i {
            0 => RowVector2 { x: self.y, y: self.z },
            1 => RowVector2 { x: self.x, y: self.z },
            2 => RowVector2 { x: self.x, y: self.y },
            _ => core::panic_with_felt252(errors::INDEX_OUT_OF_BOUNDS),
        }
    }
}
...
#[generate_trait]
impl RowVector3EditImpl<T, +Copy<T>, +Drop<T>> of RowVector3EditTrait<T> {
...
/// The 1 consecutive rows of a `RowVector3` as a `RowVector3`. Upstream: `fixed_rows::<1>`,
...
> of FixedRows<RowVector3<T>, RowVector3<T>> {
    ...
    #[inline(always)]
    fn rows(self: RowVector3<T>, first_row: usize, nrows: usize) -> RowVector3<T> {
        if nrows != 1 {
    ...
    #[inline(always)]
    fn rows_range(self: RowVector3<T>, rows: Range<usize>) -> RowVector3<T> {
...
/// The 1 consecutive columns of a `RowVector3` as a `Matrix1`. Upstream: `fixed_columns::<1>`,
...
> of FixedColumns<RowVector3<T>, Matrix1<T>> {
    ...
    #[inline(always)]
    fn columns(self: RowVector3<T>, first_col: usize, ncols: usize) -> Matrix1<T> {
        if ncols != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
    ...
    #[inline(always)]
    fn columns_range(self: RowVector3<T>, cols: Range<usize>) -> Matrix1<T> {
...
/// The 2 consecutive columns of a `RowVector3` as a `RowVector2`. Upstream: `fixed_columns::<2>`,
...
> of FixedColumns<RowVector3<T>, RowVector2<T>> {
    ...
    #[inline(always)]
    fn columns(self: RowVector3<T>, first_col: usize, ncols: usize) -> RowVector2<T> {
        if ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_columns(self, first_col)
    ...
    #[inline(always)]
    fn columns_range(self: RowVector3<T>, cols: Range<usize>) -> RowVector2<T> {
        let Range { start, end } = cols;
        if end != start + 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 3 consecutive columns of a `RowVector3` as a `RowVector3`. Upstream: `fixed_columns::<3>`,
...
> of FixedColumns<RowVector3<T>, RowVector3<T>> {
    ...
    #[inline(always)]
    fn columns(self: RowVector3<T>, first_col: usize, ncols: usize) -> RowVector3<T> {
        if ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        Self::fixed_columns(self, first_col)
    ...
    #[inline(always)]
    fn columns_range(self: RowVector3<T>, cols: Range<usize>) -> RowVector3<T> {
        let Range { start, end } = cols;
        if end != start + 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The 1x1 blocks of a `RowVector3` as a `Matrix1`. Upstream: `fixed_view::<1, 1>`, `view`, and the
...
pub impl RowVector3FixedViewMatrix1<T, +Copy<T>, +Drop<T>> of FixedView<RowVector3<T>, Matrix1<T>> {
    ...
    #[inline(always)]
    fn view(self: RowVector3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix1<T> {
        let (irow, icol) = start;
    ...
    #[inline(always)]
    fn fixed_slice(self: RowVector3<T>, irow: usize, icol: usize) -> Matrix1<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: RowVector3<T>, start: (usize, usize), shape: (usize, usize)) -> Matrix1<T> {
        Self::view(self, start, shape)
    }
}

/// The 1x2 blocks of a `RowVector3` as a `RowVector2`. Upstream: `fixed_view::<1, 2>`, `view`, and
...
> of FixedView<RowVector3<T>, RowVector2<T>> {
    ...
    #[inline(always)]
    fn view(self: RowVector3<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector2<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 1 || ncols != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: RowVector3<T>, irow: usize, icol: usize) -> RowVector2<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: RowVector3<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector2<T> {
        Self::view(self, start, shape)
    }
}

/// The 1x3 blocks of a `RowVector3` as a `RowVector3`. Upstream: `fixed_view::<1, 3>`, `view`, and
/// the deprecated `fixed_slice` / `slice`.
...
> of FixedView<RowVector3<T>, RowVector3<T>> {
    ...
    #[inline(always)]
    fn view(self: RowVector3<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector3<T> {
        let (irow, icol) = start;
        let (nrows, ncols) = shape;
        if nrows != 1 || ncols != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
    ...
    #[inline(always)]
    fn fixed_slice(self: RowVector3<T>, irow: usize, icol: usize) -> RowVector3<T> {
        Self::fixed_view(self, irow, icol)
    }

    #[inline(always)]
    fn slice(self: RowVector3<T>, start: (usize, usize), shape: (usize, usize)) -> RowVector3<T> {
        Self::view(self, start, shape)
    }
}

/// The first 1 components of a row of a `RowVector3` as a `Matrix1`. Upstream: `row_part` (`n =
/// 1`).
pub impl RowVector3RowPartMatrix1<T, +Copy<T>, +Drop<T>> of RowPart<RowVector3<T>, Matrix1<T>> {
    #[inline(always)]
    fn row_part(self: RowVector3<T>, i: usize, n: usize) -> Matrix1<T> {
        if n != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The first 2 components of a row of a `RowVector3` as a `RowVector2`. Upstream: `row_part` (`n =
/// 2`).
pub impl RowVector3RowPartRowVector2<
    T, +Copy<T>, +Drop<T>,
> of RowPart<RowVector3<T>, RowVector2<T>> {
    #[inline(always)]
    fn row_part(self: RowVector3<T>, i: usize, n: usize) -> RowVector2<T> {
        if n != 2 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, i, 0)
...
/// The first 3 components of a row of a `RowVector3` as a `RowVector3`. Upstream: `row_part` (`n =
/// 3`).
pub impl RowVector3RowPartRowVector3<
    T, +Copy<T>, +Drop<T>,
> of RowPart<RowVector3<T>, RowVector3<T>> {
    #[inline(always)]
    fn row_part(self: RowVector3<T>, i: usize, n: usize) -> RowVector3<T> {
        if n != 3 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
        FixedView::fixed_view(self, i, 0)
...
/// The first 1 components of a column of a `RowVector3` as a `Matrix1`. Upstream: `column_part` (`n
/// = 1`).
pub impl RowVector3ColumnPartMatrix1<
    T, +Copy<T>, +Drop<T>,
> of ColumnPart<RowVector3<T>, Matrix1<T>> {
    #[inline(always)]
    fn column_part(self: RowVector3<T>, i: usize, n: usize) -> Matrix1<T> {
        if n != 1 {
            core::panic_with_felt252(errors::DIMENSION_MISMATCH)
        }
...
/// The Kronecker product of a `RowVector3` and a `Vector6`, a `Matrix6x3`: one floored product per
/// component. Panics on overflow. Upstream: `kronecker`.
pub impl RowVector3KroneckerVector6<
    T, +Mul<T>, +Copy<T>, +Drop<T>,
> of MatrixKronecker<RowVector3<T>, Vector6<T>> {
    type Output = Matrix6x3<T>;
    fn kronecker(self: RowVector3<T>, rhs: Vector6<T>) -> Matrix6x3<T> {
        Matrix6x3 {
            m11: self.x * rhs.x,
            m21: self.x * rhs.y,
            m31: self.x * rhs.z,
