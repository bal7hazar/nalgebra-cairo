...
> of Svd1Trait<T> {
    ...
    fn to_polar(self: Svd1<T>) -> Option<(Matrix1<T>, Matrix1<T>)> {
        ...
        Some((Matrix1 { x: p0_0 }, Matrix1 { x: self.u.x * self.v_t.x }))
    }
...
/// Crate-internal kernels of `Svd1<T>`: the Gram matrix, the decomposition from the right
