...
//! `Svd6x4`: the singular value decomposition `M = U · Σ · Vᵀ` of a `Matrix6x4` (upstream
//! `nalgebra::linalg::SVD<T, U6, U4>`), its pseudo-inverse, least-squares solve, rank and polar
...
pub struct Svd6x4<T> {
    /// The left singular vectors, as columns (6x4).
    pub u: Matrix6x4<T>,
...
#[cfg(test)]
impl Svd6x4PartialEq<T, +PartialEq<T>> of PartialEq<Svd6x4<T>> {
    fn eq(lhs: @Svd6x4<T>, rhs: @Svd6x4<T>) -> bool {
        lhs.u == rhs.u && lhs.singular_values == rhs.singular_values && lhs.v_t == rhs.v_t
    }
}

/// Methods of `Svd6x4<T>` for any `Real` scalar.
#[generate_trait]
pub impl Svd6x4Impl<
    T,
    impl R: Real<T>,
...
> of Svd6x4Trait<T> {
    ...
    fn new(matrix: Matrix6x4<T>) -> Svd6x4<T> {
        Svd6x4InternalTrait::from_right(matrix, Svd6x4InternalTrait::right(matrix))
    }
    ...
    fn try_new(matrix: Matrix6x4<T>, eps: T, max_niter: usize) -> Option<Svd6x4<T>> {
        let _ = max_niter;
        match Svd6x4InternalTrait::try_right(matrix, eps) {
            Some(v) => Some(Svd6x4InternalTrait::from_right(matrix, v)),
            None => None,
        }
    }
    ...
    #[inline(always)]
    fn new_unordered(matrix: Matrix6x4<T>) -> Svd6x4<T> {
        Self::new(matrix)
    }

    /// `try_new`, see `new_unordered`. Upstream: `SVD::try_new_unordered`.
    #[inline(always)]
    fn try_new_unordered(matrix: Matrix6x4<T>, eps: T, max_niter: usize) -> Option<Svd6x4<T>> {
    ...
    fn rank(self: Svd6x4<T>, eps: T) -> usize {
        let mut n: usize = 0;
    ...
    fn recompose(self: Svd6x4<T>) -> Matrix6x4<T> {
        ...
        Matrix6x4 {
            ...
            m61: R::sum_prod4(
                a5_0, self.v_t.m11, a5_1, self.v_t.m21, a5_2, self.v_t.m31, a5_3, self.v_t.m41,
            ),
            m12: R::sum_prod4(
            ...
            m62: R::sum_prod4(
                a5_0, self.v_t.m12, a5_1, self.v_t.m22, a5_2, self.v_t.m32, a5_3, self.v_t.m42,
            ),
            m13: R::sum_prod4(
            ...
            m63: R::sum_prod4(
                a5_0, self.v_t.m13, a5_1, self.v_t.m23, a5_2, self.v_t.m33, a5_3, self.v_t.m43,
            ),
            m14: R::sum_prod4(
            ...
            m64: R::sum_prod4(
                a5_0, self.v_t.m14, a5_1, self.v_t.m24, a5_2, self.v_t.m34, a5_3, self.v_t.m44,
            ),
        }
    }

    /// The Moore-Penrose pseudo-inverse `V · diag(σ⁺) · Uᵀ` (4x6), `σ⁺_i = 1 / σ_i` when
    ...
    fn pseudo_inverse(self: Svd6x4<T>, eps: T) -> Option<Matrix4x6<T>> {
        ...
        Some(
            Matrix4x6 {
                ...
                m16: R::sum_prod4(
                    b0_0, self.u.m61, b0_1, self.u.m62, b0_2, self.u.m63, b0_3, self.u.m64,
                ),
                m26: R::sum_prod4(
                    b1_0, self.u.m61, b1_1, self.u.m62, b1_2, self.u.m63, b1_3, self.u.m64,
                ),
                m36: R::sum_prod4(
                    b2_0, self.u.m61, b2_1, self.u.m62, b2_2, self.u.m63, b2_3, self.u.m64,
                ),
                m46: R::sum_prod4(
                    b3_0, self.u.m61, b3_1, self.u.m62, b3_2, self.u.m63, b3_3, self.u.m64,
                ),
            },
        )
    }
    ...
    fn solve(self: Svd6x4<T>, b: Vector6<T>, eps: T) -> Option<Vector4<T>> {
        if eps.is_sign_negative() {
            return None;
        }
    ...
    /// and `U = u · v_t` (6x4). Two roundings per entry of `P`, one per entry of `U`. Always
    /// `Some` (upstream returns `None` only when `u` or `v_t` was not computed). Panics on
    /// overflow. Upstream: `SVD::to_polar`.
    fn to_polar(self: Svd6x4<T>) -> Option<(Matrix6<T>, Matrix6x4<T>)> {
        let a0_0 = self.u.m11 * self.singular_values.x;
        let a0_1 = self.u.m12 * self.singular_values.y;
        let a0_2 = self.u.m13 * self.singular_values.z;
        let a0_3 = self.u.m14 * self.singular_values.w;
        ...
        let p0_5 = R::sum_prod4(
            a0_0, self.u.m61, a0_1, self.u.m62, a0_2, self.u.m63, a0_3, self.u.m64,
        );
        ...
        let p1_5 = R::sum_prod4(
            a1_0, self.u.m61, a1_1, self.u.m62, a1_2, self.u.m63, a1_3, self.u.m64,
        );
        ...
        let p2_5 = R::sum_prod4(
            a2_0, self.u.m61, a2_1, self.u.m62, a2_2, self.u.m63, a2_3, self.u.m64,
        );
        ...
        let p3_5 = R::sum_prod4(
            a3_0, self.u.m61, a3_1, self.u.m62, a3_2, self.u.m63, a3_3, self.u.m64,
        );
        let p4_4 = R::sum_prod4(
            a4_0, self.u.m51, a4_1, self.u.m52, a4_2, self.u.m53, a4_3, self.u.m54,
        );
        let p4_5 = R::sum_prod4(
            a4_0, self.u.m61, a4_1, self.u.m62, a4_2, self.u.m63, a4_3, self.u.m64,
        );
        let p5_5 = R::sum_prod4(
            a5_0, self.u.m61, a5_1, self.u.m62, a5_2, self.u.m63, a5_3, self.u.m64,
        );
        Some(
            (
                Matrix6 {
    ...
    fn sort_by_singular_values(ref self: Svd6x4<T>) {
...
/// Crate-internal kernels of `Svd6x4<T>`: the Gram matrix, the decomposition from the right
/// singular vectors, the singular values alone.
#[generate_trait]
pub(crate) impl Svd6x4InternalImpl<
    T,
    impl R: Real<T>,
    +Copy<T>,
    +Drop<T>,
    ...
    +PartialEq<T>,
    +PartialOrd<T>,
> of Svd6x4InternalTrait<T> {
    /// `MᵀM` (10 fused sums of 6 products, one rounding each). Panics on overflow.
    #[inline(always)]
    fn gram(m: Matrix6x4<T>) -> Sym4<T> {
        Sym4 {
            m11: R::wide_rescale(
                R::wide_add_prod(
                    R::wide_add_prod(
    ...
    fn from_right(m: Matrix6x4<T>, v: Matrix4<T>) -> Svd6x4<T> {
        revoke_ap_tracking();
        ...
        let w0 = Vector6 {
            ...
            b: R::sum_prod4(m.m61, v0.x, m.m62, v0.y, m.m63, v0.z, m.m64, v0.w),
        };
        let w1 = Vector6 {
            ...
            b: R::sum_prod4(m.m61, v1.x, m.m62, v1.y, m.m63, v1.z, m.m64, v1.w),
        };
        let w2 = Vector6 {
            ...
            b: R::sum_prod4(m.m61, v2.x, m.m62, v2.y, m.m63, v2.z, m.m64, v2.w),
        };
        let w3 = Vector6 {
            ...
            b: R::sum_prod4(m.m61, v3.x, m.m62, v3.y, m.m63, v3.z, m.m64, v3.w),
        };
        let s0 = R::wide_sqrt(
            R::wide_add_prod(
                R::wide_add_prod(
    ...
    fn values_from_right(m: Matrix6x4<T>, v: Matrix4<T>) -> Vector4<T> {
        revoke_ap_tracking();
        let v0 = Vector4 { x: v.m11, y: v.m21, z: v.m31, w: v.m41 };
        let v1 = Vector4 { x: v.m12, y: v.m22, z: v.m32, w: v.m42 };
        let v2 = Vector4 { x: v.m13, y: v.m23, z: v.m33, w: v.m43 };
...
/// Upstream's `Matrix` methods that go through the SVD, on `Matrix6x4`. Import `Matrix6x4SvdTrait`
/// to use them.
#[generate_trait]
pub impl Matrix6x4SvdImpl<
    T,
    impl R: Real<T>,
    +Copy<T>,
    +Drop<T>,
    ...
    +PartialEq<T>,
    +PartialOrd<T>,
> of Matrix6x4SvdTrait<T> {
    /// The singular value decomposition, see `Svd6x4Trait::new`. Upstream: `Matrix::svd(true,
    /// true)`.
    #[inline(always)]
    fn svd(self: Matrix6x4<T>) -> Svd6x4<T> {
        Svd6x4Trait::new(self)
    }

    /// `svd` (already sorted, see `Svd6x4Trait::new_unordered`). Upstream: `Matrix::svd_unordered`.
    #[inline(always)]
    fn svd_unordered(self: Matrix6x4<T>) -> Svd6x4<T> {
        Svd6x4Trait::new(self)
    }

    /// See `Svd6x4Trait::try_new`. Upstream: `Matrix::try_svd(true, true, eps, max_niter)`.
    #[inline(always)]
    fn try_svd(self: Matrix6x4<T>, eps: T, max_niter: usize) -> Option<Svd6x4<T>> {
        Svd6x4Trait::try_new(self, eps, max_niter)
    }

    /// See `Svd6x4Trait::try_new_unordered`. Upstream: `Matrix::try_svd_unordered`.
    #[inline(always)]
    fn try_svd_unordered(self: Matrix6x4<T>, eps: T, max_niter: usize) -> Option<Svd6x4<T>> {
        Svd6x4Trait::try_new(self, eps, max_niter)
    }
    ...
    fn singular_values(self: Matrix6x4<T>) -> Vector4<T> {
        Svd6x4InternalTrait::values_from_right(self, Svd6x4InternalTrait::right(self))
    }

    /// `singular_values` (sorted; see `Svd6x4Trait::new_unordered`). Upstream:
    /// `Matrix::singular_values_unordered`.
    #[inline(always)]
    fn singular_values_unordered(self: Matrix6x4<T>) -> Vector4<T> {
    ...
    /// here).
    fn rank(self: Matrix6x4<T>, eps: T) -> usize {
    ...
    /// The Moore-Penrose pseudo-inverse, see `Svd6x4Trait::pseudo_inverse`. Upstream:
    /// `Matrix::pseudo_inverse` (`Err` on a negative `eps`; `None` here).
    #[inline(always)]
    fn pseudo_inverse(self: Matrix6x4<T>, eps: T) -> Option<Matrix4x6<T>> {
        Svd6x4Trait::new(self).pseudo_inverse(eps)
    }

    /// The left polar decomposition `M = P · U`, see `Svd6x4Trait::to_polar`. Upstream:
    /// `Matrix::polar`.
    fn polar(self: Matrix6x4<T>) -> (Matrix6<T>, Matrix6x4<T>) {
        Svd6x4Trait::new(self).to_polar().unwrap()
    }

    /// `polar`, or `None` when the decomposition did not converge within `eps`, see
    /// `Svd6x4Trait::try_new`. Upstream: `Matrix::try_polar`.
    fn try_polar(
        self: Matrix6x4<T>, eps: T, max_niter: usize,
    ) -> Option<(Matrix6<T>, Matrix6x4<T>)> {
        match Svd6x4Trait::try_new(self, eps, max_niter) {
            Some(d) => d.to_polar(),
            None => None,
        }
    }
