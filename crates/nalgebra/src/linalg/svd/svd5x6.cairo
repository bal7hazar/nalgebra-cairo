...
//! `Svd5x6`: the singular value decomposition `M = U · Σ · Vᵀ` of a `Matrix5x6` (upstream
//! `nalgebra::linalg::SVD<T, U5, U6>`), its pseudo-inverse, least-squares solve, rank and polar
...
use super::svd6x5::{Svd6x5InternalTrait, Svd6x5Trait};
...
> of Svd5x6Trait<T> {
    ...
    fn rank(self: Svd5x6<T>, eps: T) -> usize {
        let mut n: usize = 0;
                    ...
                    m16: R::wide_rescale(
                        R::wide_add_prod(
                            R::wide_add_prod(
                                R::wide_add_prod(
                                    R::wide_add_prod(
                                        R::wide_add_prod(R::wide_zero(), self.u.m11, self.v_t.m16),
                                        self.u.m12,
                                        self.v_t.m26,
                                    ),
                                    self.u.m13,
                    ...
                    m26: R::wide_rescale(
                        R::wide_add_prod(
                            R::wide_add_prod(
                                R::wide_add_prod(
                                    R::wide_add_prod(
                                        R::wide_add_prod(R::wide_zero(), self.u.m21, self.v_t.m16),
                                        self.u.m22,
                                        self.v_t.m26,
                                    ),
                                    self.u.m23,
                    ...
                    m36: R::wide_rescale(
                        R::wide_add_prod(
                            R::wide_add_prod(
                                R::wide_add_prod(
                                    R::wide_add_prod(
                                        R::wide_add_prod(R::wide_zero(), self.u.m31, self.v_t.m16),
                                        self.u.m32,
                                        self.v_t.m26,
                                    ),
                                    self.u.m33,
                    ...
                    m46: R::wide_rescale(
                        R::wide_add_prod(
                            R::wide_add_prod(
                                R::wide_add_prod(
                                    R::wide_add_prod(
                                        R::wide_add_prod(R::wide_zero(), self.u.m41, self.v_t.m16),
                                        self.u.m42,
                                        self.v_t.m26,
                                    ),
                                    self.u.m43,
                    ...
                    m56: R::wide_rescale(
                        R::wide_add_prod(
                            R::wide_add_prod(
                                R::wide_add_prod(
                                    R::wide_add_prod(
                                        R::wide_add_prod(R::wide_zero(), self.u.m51, self.v_t.m16),
                                        self.u.m52,
                                        self.v_t.m26,
                                    ),
                                    self.u.m53,
...
/// Upstream's `Matrix` methods that go through the SVD, on `Matrix5x6`. Import `Matrix5x6SvdTrait`
/// to use them.
#[generate_trait]
pub impl Matrix5x6SvdImpl<
    T,
    impl R: Real<T>,
    +Copy<T>,
    +Drop<T>,
...
> of Matrix5x6SvdTrait<T> {
    ...
    fn singular_values(self: Matrix5x6<T>) -> Vector5<T> {
        {
            ...
            Svd6x5InternalTrait::values_from_right(t, Svd6x5InternalTrait::right(t))
        }
    }

    /// `singular_values` (sorted; see `Svd5x6Trait::new_unordered`). Upstream:
    /// `Matrix::singular_values_unordered`.
    #[inline(always)]
    fn singular_values_unordered(self: Matrix5x6<T>) -> Vector5<T> {
    ...
    /// here).
    fn rank(self: Matrix5x6<T>, eps: T) -> usize {
    ...
    /// The Moore-Penrose pseudo-inverse, see `Svd5x6Trait::pseudo_inverse`. Upstream:
    ...
    /// `Svd5x6Trait::try_new`. Upstream: `Matrix::try_polar`.
    fn try_polar(
