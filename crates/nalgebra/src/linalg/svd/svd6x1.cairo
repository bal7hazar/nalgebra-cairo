            ...
            R::wide_add_prod(
                R::wide_add_prod(
                    R::wide_add_prod(
                        R::wide_add_prod(
                            R::wide_add_prod(
                                R::wide_add_prod(R::wide_zero(), self.u.x, b.x), self.u.y, b.y,
                            ),
                            self.u.z,
                            b.z,
                        ),
        ...
        Some(
            (
                ...
                Vector6 {
                    ...
                    y: self.u.y * self.v_t.x,
                    z: self.u.z * self.v_t.x,
                    w: self.u.w * self.v_t.x,
                    a: self.u.a * self.v_t.x,
                    b: self.u.b * self.v_t.x,
                },
            ),
        )
    }
...
/// Crate-internal kernels of `Svd6x1<T>`: the Gram matrix, the decomposition from the right
