    ...
    let e = black_box(
        m6(
            [
                ...
                [2625460419, 4958875604, -941745570, 5107545028, 4074451472, 218945968],
                [641578630, 636814517, -3269112063, -1412974282, -1181820813, 845644872],
                [1118040539, -1417102435, 2352776611, 4995058987, -543304443, 3221342200],
                [727980405, -2910510775, -1535245699, 3014081671, 5814961886, -4536659],
                [320260371, -37142391, -2667692282, -1538893104, 179474862, 3983829884],
            ],
        ),
    );
    ...
    let e = black_box(
        m6(
            [
                ...
                [523911086, 587531568, -4013521423, -3451539332, -1664843279, 3983829883],
            ],
        ),
    );
...
fn bench_lu6_solve__substitution() {
    ...
    let b = black_box(b_bench());
    let e = black_box(
        Some(v6t((-11208158818, -7248812507, 3383102673, 4212967580, 4206763123, -9649832808))),
    );
    assert!(f.solve(b) == e);
}
...
fn bench_lu6_solve__alt_recip() {
    ...
    let b = black_box(b_bench());
    let e = black_box(
        Some(v6t((-11208158818, -7248812506, 3383102673, 4212967579, 4206763122, -9649832809))),
    );
...
fn bench_lu6_try_inverse__columns() {
    ...
    let e = black_box(
        Some(
            m6(
                [
                    [-1634328749, -1328909173, -3540643763, 384598172, 758821032, 644873741],
                    [1278427182, -3347589151, -334138951, 113652953, -560814343, 3340191840],
                    [-131306983, -1399877948, 769507537, -4750312464, 277298268, 2486987573],
                    [1485628124, 469812391, -922548164, -2942963829, 2293487810, -2985781542],
                    [1066424137, 3172138808, -962445433, 2354884600, -2224819312, 3612501],
                    [230737289, -193491863, -1193168034, 1823649346, 1794867665, 4630404563],
                ],
            ),
        ),
    );
        ...
        Some(
            m6(
                [
                    ...
                    [1278427182, -3347589150, -334138950, 113652954, -560814343, 3340191840],
                    [-131306984, -1399877949, 769507538, -4750312464, 277298268, 2486987574],
...
fn bench_matrix6_lu__try_inverse() {
    ...
    let e = black_box(
        Some(
            m6(
                [
                    [-1634328749, -1328909173, -3540643764, 384598172, 758821031, 644873742],
                    [1278427182, -3347589150, -334138952, 113652954, -560814343, 3340191840],
                    [-131306983, -1399877948, 769507537, -4750312464, 277298268, 2486987574],
                    [1485628125, 469812391, -922548164, -2942963830, 2293487811, -2985781544],
                    [1066424136, 3172138807, -962445432, 2354884600, -2224819312, 3612502],
                    [230737288, -193491862, -1193168034, 1823649345, 1794867665, 4630404563],
                ],
            ),
        ),
    );
...
fn bench_matrix6_lu__solve() {
    ...
    let b = black_box(b_bench());
    let e = black_box(
        Some(v6t((-11208158817, -7248812507, 3383102673, 4212967580, 4206763122, -9649832805))),
    );
    assert!(a.solve(b) == e);
}
