...
> of Svd3Trait<T> {
    ...
    fn new(matrix: Matrix3<T>) -> Svd3<T> {
        ...
        let v1 = Vector3 { x: c1.x / n1, y: c1.y / n1, z: c1.z / n1 };
        let v2 = Vector3 { x: c2.x / n2, y: c2.y / n2, z: c2.z / n2 };
        let v3 = v1.cross(v2);
        ...
        let u1 = if s1 == R::ZERO {
            ...
            Vector3 { x: w1.x / s1, y: w1.y / s1, z: w1.z / s1 }
        };
        ...
        let u2 = if n == R::ZERO {
            ...
            Vector3 { x: g.x / n, y: g.y / n, z: g.z / n }
        };
        let c = u1.cross(u2);
