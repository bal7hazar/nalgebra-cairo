...
/// An isometry from raw components, `((tx, ty, tz), (w, i, j, k))` like the oracle.
fn iso(t: (i64, i64, i64), r: (i64, i64, i64, i64)) -> Isometry3<Fixed> {
    let (tx, ty, tz) = t;
    let (w, i, j, k) = r;
...
fn a() -> Isometry3<Fixed> {
    iso((6442450944, -9663676416, 16106127360), (4234293283, 534340439, -400755330, 267170219))
}

/// `new((-0.75, 0.5, 1.25), (-0.5, 0.375, 0.875))`.
fn b() -> Isometry3<Fixed> {
    iso((-3221225472, 2147483648, 5368709120), (3689020097, -1022754606, 767065954, 1789820560))
}
...
fn bench_isometry3_identity__baseline() {
    ...
    let e: Isometry3<Fixed> = black_box(iso((0, 0, 0), (0x100000000, 0, 0, 0)));
    assert!(e == e);
}
...
fn bench_isometry3_translation__baseline() {
    ...
    let e: Isometry3<Fixed> = black_box(
        iso((0x140000000, -0x60000000, 0x280000000), (0x100000000, 0, 0, 0)),
    );
    assert!(e == e);
}
...
fn bench_isometry3_from_rotation__baseline() {
    ...
    let e: Isometry3<Fixed> = black_box(iso((0, 0, 0), (0, 0, 0x100000000, 0)));
    assert!(e == e);
}
...
fn bench_isometry3_rotation__baseline() {
    let _w: Vector3<Fixed> = black_box(v3(0x40000000, -0x30000000, 0x20000000));
    let e: Isometry3<Fixed> = black_box(
        iso((0, 0, 0), (4234293283, 534340439, -400755330, 267170219)),
    );
    assert!(e == e);
}
...
fn bench_isometry3_prepend_rotation__baseline() {
    ...
    let _q: UnitQuaternion<Fixed> = black_box(r());
    let e: Isometry3<Fixed> = black_box(
        iso((6442450944, -9663676416, 16106127360), (400755330, -267170219, 4234293283, 534340439)),
    );
    assert!(e == e);
}
...
fn bench_isometry3_renormalize__baseline() {
    let _x: Isometry3<Fixed> = black_box(
        iso((6442450944, -9663676416, 16106127360), (4234293283, 534340442, -400755332, 267170219)),
    );
    let e: Isometry3<Fixed> = black_box(
        iso((6442450944, -9663676416, 16106127360), (4234293283, 534340442, -400755332, 267170219)),
    );
...
fn bench_isometry3_lerp_slerp__baseline() {
    ...
    let e: Isometry3<Fixed> = black_box(
        iso((4026531840, -6710886400, 13421772800), (4237245848, 140968788, -105726593, 679294774)),
    );
    assert!(e == e);
}
...
fn bench_isometry3_lerp_nlerp__baseline() {
    ...
    let _s: Fixed = black_box(fx(0x40000000));
    let e: Isometry3<Fixed> = black_box(
        iso((4026531840, -6710886400, 13421772800), (4238238332, 150031943, -112523959, 670006486)),
    );
    assert!(e == e);
}
...
fn bench_isometry3_face_towards__baseline() {
    ...
    let e: Isometry3<Fixed> = black_box(
        iso((0x100000000, 0x200000000, 0x300000000), (0x100000000, 0, 0, 0)),
    );
    assert!(e == e);
}
...
fn bench_isometry3_look_at_rh__baseline() {
    ...
    let _up: Vector3<Fixed> = black_box(v3(0, 0x100000000, 0));
    let e: Isometry3<Fixed> = black_box(
        iso((0x100000000, -0x200000000, 0x300000000), (0, 0, 0x100000000, 0)),
    );
    assert!(e == e);
}
...
fn bench_isometry3_abs_diff_eq__baseline() {
    ...
    let _y: Isometry3<Fixed> = black_box(
        iso((6442450946, -9663676415, 16106127360), (4234293283, 534340440, -400755330, 267170219)),
    );
