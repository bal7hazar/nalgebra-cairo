...
//!
//! Moved from `crates/nalgebra/src/linalg/lu/lu6/tests.cairo` (WP 8.1c, test-only package): the
...
use nalgebra::linalg::lu::{Perm6, Perm6Trait};
use nalgebra_testing::black_box;
use nalgebra_tests_utils::{
    Lu6PartialEq, Perm6PartialEq, abs_raw, fx, int, m6, max_abs_m6, max_abs_v6, max_ulp_diff6,
    max_ulp_diff_v6, oracle_tol, ulp_diff, v6it, v6t,
};
use crate::lu::lu6::benches::{new_no_pivot, try_inverse_recip, try_inverse_solve_columns};
use crate::lu::oracle_lu6 as oracle;
