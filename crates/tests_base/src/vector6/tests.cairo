...
//!
//! `crate::oracle_dim6_vector` is emitted from `tools/oracle` (committed vectors, 4 cases
...
//!
//! Moved from `crates/nalgebra/src/base/vector6/tests.cairo` (WP 8.1c, test-only package).

use fixed::Fixed;
use nalgebra::base::vector6::{Vector6, Vector6Trait};
use nalgebra_testing::black_box;
use nalgebra_tests_utils::{fx, int, v6, v6i, v6t};
use simba::scalar::Real;
use crate::oracle_dim6_vector as oracle;
