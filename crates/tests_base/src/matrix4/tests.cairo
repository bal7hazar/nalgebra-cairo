//!
//! Moved from `crates/nalgebra/src/base/matrix4/tests.cairo` (WP 8.1c, test-only package): the
...
use nalgebra_tests_utils::{fx, int, m4, m4i, max_ulp_diff4, ulp_diff, v4i, v4t};
use simba::scalar::Real;
use crate::{oracle_matrix4, oracle_matrix4_inverse};
