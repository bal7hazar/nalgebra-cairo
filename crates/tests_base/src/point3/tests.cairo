...
//!
//! Moved from `crates/nalgebra/src/base/point3/tests.cairo` (WP 8.1c, test-only package): the tests
...
use nalgebra_tests_utils::{fx, p2, p3, p3t, v3, v3t, v4};
use simba::scalar::Real;
use crate::point3::oracle;
