...
//! <oracle.cairo>`.
//!
//! Moved from `crates/nalgebra/src/base/vector2/tests.cairo` (WP 8.1c, test-only package).

use fixed::Fixed;
use nalgebra::base::vector2::{Vector2, Vector2AngleTrait, Vector2Trait};
use nalgebra_testing::black_box;
use nalgebra_tests_utils::{fx, v2, v2t, v3};
use simba::scalar::Real;
use crate::vector2::oracle;
